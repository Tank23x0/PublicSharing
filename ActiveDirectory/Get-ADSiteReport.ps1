<#
.SYNOPSIS
    Get-ADSiteReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADSiteReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADSiteReport"
...
Write-Log "========== Get-ADSiteReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADSiteReport Completed ==========" -Level "SUCCESS"
