<#
.SYNOPSIS
    Get-ADDisabledAccountReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADDisabledAccountReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADDisabledAccountReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADDisabledAccountReport"
...
Write-Log "========== Get-ADDisabledAccountReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADDisabledAccountReport Completed ==========" -Level "SUCCESS"
