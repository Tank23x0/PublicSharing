<#
.SYNOPSIS
    Get-ADLoginReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADLoginReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADLoginReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADLoginReport"
...
Write-Log "========== Get-ADLoginReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADLoginReport Completed ==========" -Level "SUCCESS"
