<#
.SYNOPSIS
    Get-ADAdminSDHolderReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADAdminSDHolderReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADAdminSDHolderReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADAdminSDHolderReport"
...
Write-Log "========== Get-ADAdminSDHolderReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADAdminSDHolderReport Completed ==========" -Level "SUCCESS"
