<#
.SYNOPSIS
    Get-ADPwdLastSetReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADPwdLastSetReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADPwdLastSetReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADPwdLastSetReport"
...
Write-Log "========== Get-ADPwdLastSetReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADPwdLastSetReport Completed ==========" -Level "SUCCESS"
