<#
.SYNOPSIS
    Get-ADLDAPReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADLDAPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADLDAPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADLDAPReport"
...
Write-Log "========== Get-ADLDAPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADLDAPReport Completed ==========" -Level "SUCCESS"
