<#
.SYNOPSIS
    Get-ADDelegationReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADDelegationReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADDelegationReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADDelegationReport"
...
Write-Log "========== Get-ADDelegationReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADDelegationReport Completed ==========" -Level "SUCCESS"
