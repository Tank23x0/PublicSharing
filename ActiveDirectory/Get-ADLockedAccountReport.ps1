<#
.SYNOPSIS
    Get-ADLockedAccountReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADLockedAccountReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADLockedAccountReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADLockedAccountReport"
...
Write-Log "========== Get-ADLockedAccountReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADLockedAccountReport Completed ==========" -Level "SUCCESS"
