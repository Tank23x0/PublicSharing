<#
.SYNOPSIS
    Get-ADHealthReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADHealthReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)
...
Write-Log "========== Get-ADHealthReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADHealthReport Completed ==========" -Level "SUCCESS"
