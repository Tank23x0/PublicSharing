<#
.SYNOPSIS
    Remove-ADStaleComputers.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Remove-ADStaleComputers.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Remove-ADStaleComputers_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Remove-ADStaleComputers"
...
Write-Log "========== Remove-ADStaleComputers Started ==========" -Level "INFO"
...
Write-Log "========== Remove-ADStaleComputers Completed ==========" -Level "SUCCESS"
