<#
.SYNOPSIS
    Get-ADOUReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADOUReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADOUReport"
...
Write-Log "========== Get-ADOUReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADOUReport Completed ==========" -Level "SUCCESS"
