<#
.SYNOPSIS
    Get-ADComputerReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADComputerReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADComputerReport"
...
Write-Log "========== Get-ADComputerReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADComputerReport Completed ==========" -Level "SUCCESS"
