<#
.SYNOPSIS
    New-ADUser.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\New-ADUser_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "New-ADUser"
...
Write-Log "========== New-ADUser Started ==========" -Level "INFO"
...
Write-Log "========== New-ADUser Completed ==========" -Level "SUCCESS"
