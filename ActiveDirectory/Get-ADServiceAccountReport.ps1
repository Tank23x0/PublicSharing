<#
.SYNOPSIS
    Get-ADServiceAccountReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADServiceAccountReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADServiceAccountReport"
...
Write-Log "========== Get-ADServiceAccountReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADServiceAccountReport Completed ==========" -Level "SUCCESS"
