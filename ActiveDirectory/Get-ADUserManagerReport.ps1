<#
.SYNOPSIS
    Get-ADUserManagerReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADUserManagerReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADUserManagerReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADUserManagerReport"
...
Write-Log "========== Get-ADUserManagerReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADUserManagerReport Completed ==========" -Level "SUCCESS"
