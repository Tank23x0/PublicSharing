<#
.SYNOPSIS
    Get-ADOrphanedObjectReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADOrphanedObjectReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADOrphanedObjectReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADOrphanedObjectReport"
...
Write-Log "========== Get-ADOrphanedObjectReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADOrphanedObjectReport Completed ==========" -Level "SUCCESS"
