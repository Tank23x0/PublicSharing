<#
.SYNOPSIS
    Get-ADDNSReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADDNSReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADDNSReport"
...
Write-Log "========== Get-ADDNSReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADDNSReport Completed ==========" -Level "SUCCESS"
