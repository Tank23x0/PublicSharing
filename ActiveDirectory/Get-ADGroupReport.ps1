<#
.SYNOPSIS
    Get-ADGroupReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADGroupReport"
...
Write-Log "========== Get-ADGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADGroupReport Completed ==========" -Level "SUCCESS"
