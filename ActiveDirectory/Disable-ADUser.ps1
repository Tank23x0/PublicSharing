<#
.SYNOPSIS
    Disable-ADUser.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Disable-ADUser_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Disable-ADUser"
...
Write-Log "========== Disable-ADUser Started ==========" -Level "INFO"
...
Write-Log "========== Disable-ADUser Completed ==========" -Level "SUCCESS"
