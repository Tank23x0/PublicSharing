<#
.SYNOPSIS
    Enable-ADUser.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Enable-ADUser_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Enable-ADUser"
...
Write-Log "========== Enable-ADUser Started ==========" -Level "INFO"
...
Write-Log "========== Enable-ADUser Completed ==========" -Level "SUCCESS"
