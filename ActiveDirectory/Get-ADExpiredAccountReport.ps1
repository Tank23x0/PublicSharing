<#
.SYNOPSIS
    Get-ADExpiredAccountReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADExpiredAccountReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADExpiredAccountReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADExpiredAccountReport"
...
Write-Log "========== Get-ADExpiredAccountReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADExpiredAccountReport Completed ==========" -Level "SUCCESS"
