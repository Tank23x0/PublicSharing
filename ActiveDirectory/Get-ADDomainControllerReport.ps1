<#
.SYNOPSIS
    Get-ADDomainControllerReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADDomainControllerReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADDomainControllerReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADDomainControllerReport"
...
Write-Log "========== Get-ADDomainControllerReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADDomainControllerReport Completed ==========" -Level "SUCCESS"
