<#
.SYNOPSIS
    Get-ADEmptyGroupReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADEmptyGroupReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADEmptyGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADEmptyGroupReport"
...
Write-Log "========== Get-ADEmptyGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADEmptyGroupReport Completed ==========" -Level "SUCCESS"
