<#
.SYNOPSIS
    Get-ADGroupPolicyReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADGroupPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADGroupPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADGroupPolicyReport"
...
Write-Log "========== Get-ADGroupPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADGroupPolicyReport Completed ==========" -Level "SUCCESS"
