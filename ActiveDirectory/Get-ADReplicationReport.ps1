<#
.SYNOPSIS
    Get-ADReplicationReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADReplicationReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADReplicationReport"
...
Write-Log "========== Get-ADReplicationReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADReplicationReport Completed ==========" -Level "SUCCESS"
