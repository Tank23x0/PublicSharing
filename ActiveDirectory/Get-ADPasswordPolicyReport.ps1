<#
.SYNOPSIS
    Get-ADPasswordPolicyReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADPasswordPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADPasswordPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADPasswordPolicyReport"
...
Write-Log "========== Get-ADPasswordPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADPasswordPolicyReport Completed ==========" -Level "SUCCESS"
