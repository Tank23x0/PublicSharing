<#
.SYNOPSIS
    Get-ADObjectReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADObjectReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADObjectReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADObjectReport"
...
Write-Log "========== Get-ADObjectReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADObjectReport Completed ==========" -Level "SUCCESS"
