<#
.SYNOPSIS
    Get-ADDirectReportReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADDirectReportReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADDirectReportReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADDirectReportReport"
...
Write-Log "========== Get-ADDirectReportReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADDirectReportReport Completed ==========" -Level "SUCCESS"
