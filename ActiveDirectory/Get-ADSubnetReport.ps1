<#
.SYNOPSIS
    Get-ADSubnetReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADSubnetReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADSubnetReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADSubnetReport"
...
Write-Log "========== Get-ADSubnetReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADSubnetReport Completed ==========" -Level "SUCCESS"
