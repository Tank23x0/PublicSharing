<#
.SYNOPSIS
    Get-ADAttributeReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADAttributeReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADAttributeReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADAttributeReport"
...
Write-Log "========== Get-ADAttributeReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADAttributeReport Completed ==========" -Level "SUCCESS"
