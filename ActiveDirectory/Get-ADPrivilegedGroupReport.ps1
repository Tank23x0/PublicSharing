<#
.SYNOPSIS
    Get-ADPrivilegedGroupReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADPrivilegedGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADPrivilegedGroupReport"
...
Write-Log "========== Get-ADPrivilegedGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADPrivilegedGroupReport Completed ==========" -Level "SUCCESS"
