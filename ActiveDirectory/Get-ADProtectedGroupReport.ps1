<#
.SYNOPSIS
    Get-ADProtectedGroupReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADProtectedGroupReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADProtectedGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADProtectedGroupReport"
...
Write-Log "========== Get-ADProtectedGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADProtectedGroupReport Completed ==========" -Level "SUCCESS"
