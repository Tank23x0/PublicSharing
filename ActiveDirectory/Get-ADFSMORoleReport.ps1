<#
.SYNOPSIS
    Get-ADFSMORoleReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADFSMORoleReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADFSMORoleReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADFSMORoleReport"
...
Write-Log "========== Get-ADFSMORoleReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADFSMORoleReport Completed ==========" -Level "SUCCESS"
