<#
.SYNOPSIS
    Get-ADSchemaReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADSchemaReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADSchemaReport"
...
Write-Log "========== Get-ADSchemaReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADSchemaReport Completed ==========" -Level "SUCCESS"
