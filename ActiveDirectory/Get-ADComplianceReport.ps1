<#
.SYNOPSIS
    Get-ADComplianceReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADComplianceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADComplianceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADComplianceReport"
...
Write-Log "========== Get-ADComplianceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADComplianceReport Completed ==========" -Level "SUCCESS"
