<#
.SYNOPSIS
    Get-ADCertificateReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADCertificateReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADCertificateReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADCertificateReport"
...
Write-Log "========== Get-ADCertificateReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADCertificateReport Completed ==========" -Level "SUCCESS"
