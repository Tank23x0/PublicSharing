<#
.SYNOPSIS
    Get-ADNestedGroupReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADNestedGroupReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADNestedGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADNestedGroupReport"
...
Write-Log "========== Get-ADNestedGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADNestedGroupReport Completed ==========" -Level "SUCCESS"
