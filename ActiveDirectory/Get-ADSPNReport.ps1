<#
.SYNOPSIS
    Get-ADSPNReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADSPNReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADSPNReport"
...
Write-Log "========== Get-ADSPNReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADSPNReport Completed ==========" -Level "SUCCESS"
