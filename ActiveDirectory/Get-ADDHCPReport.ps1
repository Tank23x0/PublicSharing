<#
.SYNOPSIS
    Get-ADDHCPReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADDHCPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADDHCPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADDHCPReport"
...
Write-Log "========== Get-ADDHCPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADDHCPReport Completed ==========" -Level "SUCCESS"
