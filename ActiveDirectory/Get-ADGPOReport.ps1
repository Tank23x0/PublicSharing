<#
.SYNOPSIS
    Get-ADGPOReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADGPOReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADGPOReport"
...
Write-Log "========== Get-ADGPOReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADGPOReport Completed ==========" -Level "SUCCESS"
