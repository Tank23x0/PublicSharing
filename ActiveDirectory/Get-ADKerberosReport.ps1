<#
.SYNOPSIS
    Get-ADKerberosReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADKerberosReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADKerberosReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADKerberosReport"
...
Write-Log "========== Get-ADKerberosReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADKerberosReport Completed ==========" -Level "SUCCESS"
