<#
.SYNOPSIS
    Get-ADAuditReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADAuditReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADAuditReport"
...
Write-Log "========== Get-ADAuditReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADAuditReport Completed ==========" -Level "SUCCESS"
