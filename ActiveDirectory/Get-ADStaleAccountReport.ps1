<#
.SYNOPSIS
    Get-ADStaleAccountReport.ps1 - Active Directory Management Tool
...
.EXAMPLE
    .\Get-ADStaleAccountReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADStaleAccountReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADStaleAccountReport"
...
Write-Log "========== Get-ADStaleAccountReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADStaleAccountReport Completed ==========" -Level "SUCCESS"
