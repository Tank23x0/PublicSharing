<#
.SYNOPSIS
    Get-ADUserReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADUserReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADUserReport"
...
Write-Log "========== Get-ADUserReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADUserReport Completed ==========" -Level "SUCCESS"
