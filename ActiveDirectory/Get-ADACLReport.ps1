<#
.SYNOPSIS
    Get-ADACLReport.ps1 - Active Directory Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ADACLReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$SearchBase,
    [int]$InactiveDays = 90
)

$ScriptName = "Get-ADACLReport"
...
Write-Log "========== Get-ADACLReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ADACLReport Completed ==========" -Level "SUCCESS"
