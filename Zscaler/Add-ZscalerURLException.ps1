<#
.SYNOPSIS
    Add-ZscalerURLException.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Add-ZscalerURLException.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Add-ZscalerURLException_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Add-ZscalerURLException"
...
Write-Log "========== Add-ZscalerURLException Started ==========" -Level "INFO"
...
Write-Log "========== Add-ZscalerURLException Completed ==========" -Level "SUCCESS"
