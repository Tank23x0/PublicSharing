<#
.SYNOPSIS
    Get-ZscalerHealthReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerHealthReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerHealthReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerHealthReport"
...
Write-Log "========== Get-ZscalerHealthReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerHealthReport Completed ==========" -Level "SUCCESS"
