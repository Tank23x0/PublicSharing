<#
.SYNOPSIS
    Remove-ZscalerURLException.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Remove-ZscalerURLException.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Remove-ZscalerURLException_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Remove-ZscalerURLException"
...
Write-Log "========== Remove-ZscalerURLException Started ==========" -Level "INFO"
...
Write-Log "========== Remove-ZscalerURLException Completed ==========" -Level "SUCCESS"
