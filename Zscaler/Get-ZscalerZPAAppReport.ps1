<#
.SYNOPSIS
    Get-ZscalerZPAAppReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerZPAAppReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerZPAAppReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerZPAAppReport"
...
Write-Log "========== Get-ZscalerZPAAppReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerZPAAppReport Completed ==========" -Level "SUCCESS"
