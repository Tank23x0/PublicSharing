<#
.SYNOPSIS
    Get-ZscalerZPAConnectorReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerZPAConnectorReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerZPAConnectorReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerZPAConnectorReport"
...
Write-Log "========== Get-ZscalerZPAConnectorReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerZPAConnectorReport Completed ==========" -Level "SUCCESS"
