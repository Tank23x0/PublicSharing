<#
.SYNOPSIS
    Get-ZscalerPACFileReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerPACFileReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerPACFileReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerPACFileReport"
...
Write-Log "========== Get-ZscalerPACFileReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerPACFileReport Completed ==========" -Level "SUCCESS"
