<#
.SYNOPSIS
    Get-ZscalerRiskScoreReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerRiskScoreReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerRiskScoreReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerRiskScoreReport"
...
Write-Log "========== Get-ZscalerRiskScoreReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerRiskScoreReport Completed ==========" -Level "SUCCESS"
