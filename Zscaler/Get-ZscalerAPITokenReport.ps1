<#
.SYNOPSIS
    Get-ZscalerAPITokenReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerAPITokenReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerAPITokenReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerAPITokenReport"
...
Write-Log "========== Get-ZscalerAPITokenReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerAPITokenReport Completed ==========" -Level "SUCCESS"
