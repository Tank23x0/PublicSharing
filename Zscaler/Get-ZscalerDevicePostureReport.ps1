<#
.SYNOPSIS
    Get-ZscalerDevicePostureReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerDevicePostureReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerDevicePostureReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerDevicePostureReport"
...
Write-Log "========== Get-ZscalerDevicePostureReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerDevicePostureReport Completed ==========" -Level "SUCCESS"
