<#
.SYNOPSIS
    Get-ZscalerSecurityReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerSecurityReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerSecurityReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerSecurityReport"
...
Write-Log "========== Get-ZscalerSecurityReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerSecurityReport Completed ==========" -Level "SUCCESS"
