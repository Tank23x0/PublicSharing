<#
.SYNOPSIS
    Get-ZscalerGroupReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerGroupReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerGroupReport"
...
Write-Log "========== Get-ZscalerGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerGroupReport Completed ==========" -Level "SUCCESS"
