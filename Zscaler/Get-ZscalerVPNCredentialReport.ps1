<#
.SYNOPSIS
    Get-ZscalerVPNCredentialReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerVPNCredentialReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerVPNCredentialReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerVPNCredentialReport"
...
Write-Log "========== Get-ZscalerVPNCredentialReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerVPNCredentialReport Completed ==========" -Level "SUCCESS"
