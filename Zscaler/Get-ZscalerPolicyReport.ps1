<#
.SYNOPSIS
    Get-ZscalerPolicyReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerPolicyReport"
...
Write-Log "========== Get-ZscalerPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerPolicyReport Completed ==========" -Level "SUCCESS"
