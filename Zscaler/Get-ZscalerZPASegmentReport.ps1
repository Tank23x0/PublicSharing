<#
.SYNOPSIS
    Get-ZscalerZPASegmentReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerZPASegmentReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerZPASegmentReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerZPASegmentReport"
...
Write-Log "========== Get-ZscalerZPASegmentReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerZPASegmentReport Completed ==========" -Level "SUCCESS"
