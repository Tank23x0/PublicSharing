<#
.SYNOPSIS
    Set-ZscalerPolicy.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Set-ZscalerPolicy.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Set-ZscalerPolicy_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Set-ZscalerPolicy"
...
Write-Log "========== Set-ZscalerPolicy Started ==========" -Level "INFO"
...
Write-Log "========== Set-ZscalerPolicy Completed ==========" -Level "SUCCESS"
