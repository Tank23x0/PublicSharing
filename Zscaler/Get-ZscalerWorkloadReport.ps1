<#
.SYNOPSIS
    Get-ZscalerWorkloadReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerWorkloadReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerWorkloadReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerWorkloadReport"
...
Write-Log "========== Get-ZscalerWorkloadReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerWorkloadReport Completed ==========" -Level "SUCCESS"
