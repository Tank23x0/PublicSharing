<#
.SYNOPSIS
    Get-ZscalerWebActivityReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerWebActivityReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerWebActivityReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerWebActivityReport"
...
Write-Log "========== Get-ZscalerWebActivityReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerWebActivityReport Completed ==========" -Level "SUCCESS"
