<#
.SYNOPSIS
    Get-ZscalerConfigurationReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerConfigurationReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerConfigurationReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerConfigurationReport"
...
Write-Log "========== Get-ZscalerConfigurationReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerConfigurationReport Completed ==========" -Level "SUCCESS"
