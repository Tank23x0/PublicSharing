<#
.SYNOPSIS
    Get-ZscalerTrafficReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerTrafficReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerTrafficReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerTrafficReport"
...
Write-Log "========== Get-ZscalerTrafficReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerTrafficReport Completed ==========" -Level "SUCCESS"
