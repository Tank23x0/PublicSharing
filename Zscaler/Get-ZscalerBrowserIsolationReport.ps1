<#
.SYNOPSIS
    Get-ZscalerBrowserIsolationReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerBrowserIsolationReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerBrowserIsolationReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerBrowserIsolationReport"
...
Write-Log "========== Get-ZscalerBrowserIsolationReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerBrowserIsolationReport Completed ==========" -Level "SUCCESS"
