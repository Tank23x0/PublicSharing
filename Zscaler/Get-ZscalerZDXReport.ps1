<#
.SYNOPSIS
    Get-ZscalerZDXReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerZDXReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerZDXReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerZDXReport"
...
Write-Log "========== Get-ZscalerZDXReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerZDXReport Completed ==========" -Level "SUCCESS"
