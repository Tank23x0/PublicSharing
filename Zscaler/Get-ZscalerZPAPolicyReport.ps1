<#
.SYNOPSIS
    Get-ZscalerZPAPolicyReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerZPAPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerZPAPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerZPAPolicyReport"
...
Write-Log "========== Get-ZscalerZPAPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerZPAPolicyReport Completed ==========" -Level "SUCCESS"
