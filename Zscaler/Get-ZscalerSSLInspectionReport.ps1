<#
.SYNOPSIS
    Get-ZscalerSSLInspectionReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerSSLInspectionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerSSLInspectionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerSSLInspectionReport"
...
Write-Log "========== Get-ZscalerSSLInspectionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerSSLInspectionReport Completed ==========" -Level "SUCCESS"
