<#
.SYNOPSIS
    Get-ZscalerFirewallReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerFirewallReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerFirewallReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerFirewallReport"
...
Write-Log "========== Get-ZscalerFirewallReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerFirewallReport Completed ==========" -Level "SUCCESS"
