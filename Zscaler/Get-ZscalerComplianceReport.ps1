<#
.SYNOPSIS
    Get-ZscalerComplianceReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerComplianceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerComplianceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerComplianceReport"
...
Write-Log "========== Get-ZscalerComplianceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerComplianceReport Completed ==========" -Level "SUCCESS"
