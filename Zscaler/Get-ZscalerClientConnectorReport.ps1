<#
.SYNOPSIS
    Get-ZscalerClientConnectorReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerClientConnectorReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerClientConnectorReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerClientConnectorReport"
...
Write-Log "========== Get-ZscalerClientConnectorReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerClientConnectorReport Completed ==========" -Level "SUCCESS"
