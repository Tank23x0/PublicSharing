<#
.SYNOPSIS
    Get-ZscalerSaaSReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerSaaSReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerSaaSReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerSaaSReport"
...
Write-Log "========== Get-ZscalerSaaSReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerSaaSReport Completed ==========" -Level "SUCCESS"
