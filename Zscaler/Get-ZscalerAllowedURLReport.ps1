<#
.SYNOPSIS
    Get-ZscalerAllowedURLReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerAllowedURLReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerAllowedURLReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerAllowedURLReport"
...
Write-Log "========== Get-ZscalerAllowedURLReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerAllowedURLReport Completed ==========" -Level "SUCCESS"
