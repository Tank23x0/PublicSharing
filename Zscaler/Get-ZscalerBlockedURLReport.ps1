<#
.SYNOPSIS
    Get-ZscalerBlockedURLReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerBlockedURLReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerBlockedURLReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerBlockedURLReport"
...
Write-Log "========== Get-ZscalerBlockedURLReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerBlockedURLReport Completed ==========" -Level "SUCCESS"
