<#
.SYNOPSIS
    Get-ZscalerThreatReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerThreatReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerThreatReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerThreatReport"
...
Write-Log "========== Get-ZscalerThreatReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerThreatReport Completed ==========" -Level "SUCCESS"
