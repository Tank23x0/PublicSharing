<#
.SYNOPSIS
    Get-ZscalerLocationReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerLocationReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerLocationReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerLocationReport"
...
Write-Log "========== Get-ZscalerLocationReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerLocationReport Completed ==========" -Level "SUCCESS"
