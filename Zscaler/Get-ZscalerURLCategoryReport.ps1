<#
.SYNOPSIS
    Get-ZscalerURLCategoryReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerURLCategoryReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerURLCategoryReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerURLCategoryReport"
...
Write-Log "========== Get-ZscalerURLCategoryReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerURLCategoryReport Completed ==========" -Level "SUCCESS"
