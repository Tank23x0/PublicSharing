<#
.SYNOPSIS
    Get-ZscalerCASBReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerCASBReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerCASBReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerCASBReport"
...
Write-Log "========== Get-ZscalerCASBReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerCASBReport Completed ==========" -Level "SUCCESS"
