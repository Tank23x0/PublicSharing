<#
.SYNOPSIS
    Get-ZscalerAdminAuditReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerAdminAuditReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerAdminAuditReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerAdminAuditReport"
...
Write-Log "========== Get-ZscalerAdminAuditReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerAdminAuditReport Completed ==========" -Level "SUCCESS"
