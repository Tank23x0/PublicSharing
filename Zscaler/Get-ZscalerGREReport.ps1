<#
.SYNOPSIS
    Get-ZscalerGREReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerGREReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerGREReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerGREReport"
...
Write-Log "========== Get-ZscalerGREReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerGREReport Completed ==========" -Level "SUCCESS"
