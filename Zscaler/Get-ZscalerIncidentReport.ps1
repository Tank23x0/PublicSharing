<#
.SYNOPSIS
    Get-ZscalerIncidentReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerIncidentReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerIncidentReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerIncidentReport"
...
Write-Log "========== Get-ZscalerIncidentReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerIncidentReport Completed ==========" -Level "SUCCESS"
