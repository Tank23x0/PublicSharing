<#
.SYNOPSIS
    Get-ZscalerDepartmentReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerDepartmentReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerDepartmentReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerDepartmentReport"
...
Write-Log "========== Get-ZscalerDepartmentReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerDepartmentReport Completed ==========" -Level "SUCCESS"
