<#
.SYNOPSIS
    Set-ZscalerURLCategory.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Set-ZscalerURLCategory.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Set-ZscalerURLCategory_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Set-ZscalerURLCategory"
...
Write-Log "========== Set-ZscalerURLCategory Started ==========" -Level "INFO"
...
Write-Log "========== Set-ZscalerURLCategory Completed ==========" -Level "SUCCESS"
