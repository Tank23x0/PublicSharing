<#
.SYNOPSIS
    Get-ZscalerDLPReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerDLPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerDLPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerDLPReport"
...
Write-Log "========== Get-ZscalerDLPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerDLPReport Completed ==========" -Level "SUCCESS"
