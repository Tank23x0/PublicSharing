<#
.SYNOPSIS
    Get-ZscalerBandwidthReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerBandwidthReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerBandwidthReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerBandwidthReport"
...
Write-Log "========== Get-ZscalerBandwidthReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerBandwidthReport Completed ==========" -Level "SUCCESS"
