<#
.SYNOPSIS
    Get-ZscalerZTNAReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerZTNAReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerZTNAReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerZTNAReport"
...
Write-Log "========== Get-ZscalerZTNAReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerZTNAReport Completed ==========" -Level "SUCCESS"
