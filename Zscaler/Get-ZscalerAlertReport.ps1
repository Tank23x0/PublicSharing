<#
.SYNOPSIS
    Get-ZscalerAlertReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerAlertReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerAlertReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerAlertReport"
...
Write-Log "========== Get-ZscalerAlertReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerAlertReport Completed ==========" -Level "SUCCESS"
