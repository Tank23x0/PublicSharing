<#
.SYNOPSIS
    Get-ZscalerIPSecReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerIPSecReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerIPSecReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerIPSecReport"
...
Write-Log "========== Get-ZscalerIPSecReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerIPSecReport Completed ==========" -Level "SUCCESS"
