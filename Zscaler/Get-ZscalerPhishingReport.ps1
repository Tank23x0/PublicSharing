<#
.SYNOPSIS
    Get-ZscalerPhishingReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerPhishingReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerPhishingReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerPhishingReport"
...
Write-Log "========== Get-ZscalerPhishingReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerPhishingReport Completed ==========" -Level "SUCCESS"
