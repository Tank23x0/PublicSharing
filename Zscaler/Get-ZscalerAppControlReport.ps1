<#
.SYNOPSIS
    Get-ZscalerAppControlReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerAppControlReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerAppControlReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerAppControlReport"
...
Write-Log "========== Get-ZscalerAppControlReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerAppControlReport Completed ==========" -Level "SUCCESS"
