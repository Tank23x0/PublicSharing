<#
.SYNOPSIS
    Get-ZscalerForwardingRuleReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerForwardingRuleReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerForwardingRuleReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerForwardingRuleReport"
...
Write-Log "========== Get-ZscalerForwardingRuleReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerForwardingRuleReport Completed ==========" -Level "SUCCESS"
