<#
.SYNOPSIS
    Get-ZscalerSandboxReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerSandboxReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerSandboxReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerSandboxReport"
...
Write-Log "========== Get-ZscalerSandboxReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerSandboxReport Completed ==========" -Level "SUCCESS"
