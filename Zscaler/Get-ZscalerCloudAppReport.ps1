<#
.SYNOPSIS
    Get-ZscalerCloudAppReport.ps1 - Zscaler Management Tool
...
.EXAMPLE
    .\Get-ZscalerCloudAppReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ZscalerCloudAppReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ZscalerCloud = "zscloud.net",
    [string]$ApiKey,
    [string]$Username
)

$ScriptName = "Get-ZscalerCloudAppReport"
...
Write-Log "========== Get-ZscalerCloudAppReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ZscalerCloudAppReport Completed ==========" -Level "SUCCESS"
