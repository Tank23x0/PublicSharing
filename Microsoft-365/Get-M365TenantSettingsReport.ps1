<#
.SYNOPSIS
    Get-M365TenantSettingsReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365TenantSettingsReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365TenantSettingsReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365TenantSettingsReport"
...
Write-Log "========== Get-M365TenantSettingsReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365TenantSettingsReport Completed ==========" -Level "SUCCESS"
