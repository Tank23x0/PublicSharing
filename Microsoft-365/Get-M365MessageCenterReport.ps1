<#
.SYNOPSIS
    Get-M365MessageCenterReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365MessageCenterReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365MessageCenterReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365MessageCenterReport"
...
Write-Log "========== Get-M365MessageCenterReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365MessageCenterReport Completed ==========" -Level "SUCCESS"
