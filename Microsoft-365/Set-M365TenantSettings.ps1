<#
.SYNOPSIS
    Set-M365TenantSettings.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Set-M365TenantSettings.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Set-M365TenantSettings_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Set-M365TenantSettings"
...
Write-Log "========== Set-M365TenantSettings Started ==========" -Level "INFO"
...
Write-Log "========== Set-M365TenantSettings Completed ==========" -Level "SUCCESS"
