<#
.SYNOPSIS
    Get-M365SecurityAlertReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365SecurityAlertReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365SecurityAlertReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365SecurityAlertReport"
...
Write-Log "========== Get-M365SecurityAlertReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365SecurityAlertReport Completed ==========" -Level "SUCCESS"
