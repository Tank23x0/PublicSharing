<#
.SYNOPSIS
    Enable-M365SecurityDefaults.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Enable-M365SecurityDefaults.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Enable-M365SecurityDefaults_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Enable-M365SecurityDefaults"
...
Write-Log "========== Enable-M365SecurityDefaults Started ==========" -Level "INFO"
...
Write-Log "========== Enable-M365SecurityDefaults Completed ==========" -Level "SUCCESS"
