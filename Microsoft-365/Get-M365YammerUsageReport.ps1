<#
.SYNOPSIS
    Get-M365YammerUsageReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365YammerUsageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365YammerUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365YammerUsageReport"
...
Write-Log "========== Get-M365YammerUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365YammerUsageReport Completed ==========" -Level "SUCCESS"
