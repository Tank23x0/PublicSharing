<#
.SYNOPSIS
    Get-M365SupportTicketReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365SupportTicketReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365SupportTicketReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365SupportTicketReport"
...
Write-Log "========== Get-M365SupportTicketReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365SupportTicketReport Completed ==========" -Level "SUCCESS"
