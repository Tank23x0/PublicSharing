<#
.SYNOPSIS
    Get-M365DataGovernanceReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365DataGovernanceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365DataGovernanceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365DataGovernanceReport"
...
Write-Log "========== Get-M365DataGovernanceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365DataGovernanceReport Completed ==========" -Level "SUCCESS"
