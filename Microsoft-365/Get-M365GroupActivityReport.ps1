<#
.SYNOPSIS
    Get-M365GroupActivityReport.ps1 - Microsoft 365 Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365GroupActivityReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365GroupActivityReport"
...
Write-Log "========== Get-M365GroupActivityReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365GroupActivityReport Completed ==========" -Level "SUCCESS"
