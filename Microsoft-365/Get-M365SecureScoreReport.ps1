<#
.SYNOPSIS
    Get-M365SecureScoreReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365SecureScoreReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365SecureScoreReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365SecureScoreReport"
...
Write-Log "========== Get-M365SecureScoreReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365SecureScoreReport Completed ==========" -Level "SUCCESS"
