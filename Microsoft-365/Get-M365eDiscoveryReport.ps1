<#
.SYNOPSIS
    Get-M365eDiscoveryReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365eDiscoveryReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365eDiscoveryReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365eDiscoveryReport"
...
Write-Log "========== Get-M365eDiscoveryReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365eDiscoveryReport Completed ==========" -Level "SUCCESS"
