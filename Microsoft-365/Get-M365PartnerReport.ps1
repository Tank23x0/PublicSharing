<#
.SYNOPSIS
    Get-M365PartnerReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365PartnerReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365PartnerReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365PartnerReport"
...
Write-Log "========== Get-M365PartnerReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365PartnerReport Completed ==========" -Level "SUCCESS"
