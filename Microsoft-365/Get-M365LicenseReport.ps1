<#
.SYNOPSIS
    Get-M365LicenseReport.ps1 - Microsoft 365 Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365LicenseReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365LicenseReport"
...
Write-Log "========== Get-M365LicenseReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365LicenseReport Completed ==========" -Level "SUCCESS"
