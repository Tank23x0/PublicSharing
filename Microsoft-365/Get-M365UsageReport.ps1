<#
.SYNOPSIS
    Get-M365UsageReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365UsageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365UsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365UsageReport"
...
Write-Log "========== Get-M365UsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365UsageReport Completed ==========" -Level "SUCCESS"
