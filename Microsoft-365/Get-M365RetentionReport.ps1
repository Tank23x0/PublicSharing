<#
.SYNOPSIS
    Get-M365RetentionReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365RetentionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365RetentionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365RetentionReport"
...
Write-Log "========== Get-M365RetentionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365RetentionReport Completed ==========" -Level "SUCCESS"
