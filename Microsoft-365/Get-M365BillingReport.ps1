<#
.SYNOPSIS
    Get-M365BillingReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365BillingReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365BillingReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365BillingReport"
...
Write-Log "========== Get-M365BillingReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365BillingReport Completed ==========" -Level "SUCCESS"
