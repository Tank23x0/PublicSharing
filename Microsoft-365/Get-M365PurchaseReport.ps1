<#
.SYNOPSIS
    Get-M365PurchaseReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365PurchaseReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365PurchaseReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365PurchaseReport"
...
Write-Log "========== Get-M365PurchaseReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365PurchaseReport Completed ==========" -Level "SUCCESS"
