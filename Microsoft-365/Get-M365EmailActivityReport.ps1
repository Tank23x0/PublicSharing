<#
.SYNOPSIS
    Get-M365EmailActivityReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365EmailActivityReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365EmailActivityReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365EmailActivityReport"
...
Write-Log "========== Get-M365EmailActivityReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365EmailActivityReport Completed ==========" -Level "SUCCESS"
