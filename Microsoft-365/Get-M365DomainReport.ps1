<#
.SYNOPSIS
    Get-M365DomainReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365DomainReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365DomainReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365DomainReport"
...
Write-Log "========== Get-M365DomainReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365DomainReport Completed ==========" -Level "SUCCESS"
