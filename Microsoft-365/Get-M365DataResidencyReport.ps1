<#
.SYNOPSIS
    Get-M365DataResidencyReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365DataResidencyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365DataResidencyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365DataResidencyReport"
...
Write-Log "========== Get-M365DataResidencyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365DataResidencyReport Completed ==========" -Level "SUCCESS"
