<#
.SYNOPSIS
    Get-M365ConditionalAccessReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365ConditionalAccessReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365ConditionalAccessReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365ConditionalAccessReport"
...
Write-Log "========== Get-M365ConditionalAccessReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365ConditionalAccessReport Completed ==========" -Level "SUCCESS"
