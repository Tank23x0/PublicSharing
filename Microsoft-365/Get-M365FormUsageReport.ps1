<#
.SYNOPSIS
    Get-M365FormUsageReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365FormUsageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365FormUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365FormUsageReport"
...
Write-Log "========== Get-M365FormUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365FormUsageReport Completed ==========" -Level "SUCCESS"
