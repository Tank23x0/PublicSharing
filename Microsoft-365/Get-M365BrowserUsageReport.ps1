<#
.SYNOPSIS
    Get-M365BrowserUsageReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365BrowserUsageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365BrowserUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365BrowserUsageReport"
...
Write-Log "========== Get-M365BrowserUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365BrowserUsageReport Completed ==========" -Level "SUCCESS"
