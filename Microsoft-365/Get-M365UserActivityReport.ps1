<#
.SYNOPSIS
    Get-M365UserActivityReport.ps1 - Microsoft 365 Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365UserActivityReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365UserActivityReport"
...
Write-Log "========== Get-M365UserActivityReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365UserActivityReport Completed ==========" -Level "SUCCESS"
