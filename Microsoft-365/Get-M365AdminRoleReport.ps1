<#
.SYNOPSIS
    Get-M365AdminRoleReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365AdminRoleReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365AdminRoleReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365AdminRoleReport"
...
Write-Log "========== Get-M365AdminRoleReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365AdminRoleReport Completed ==========" -Level "SUCCESS"
