<#
.SYNOPSIS
    Get-M365LegalHoldReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365LegalHoldReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365LegalHoldReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365LegalHoldReport"
...
Write-Log "========== Get-M365LegalHoldReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365LegalHoldReport Completed ==========" -Level "SUCCESS"
