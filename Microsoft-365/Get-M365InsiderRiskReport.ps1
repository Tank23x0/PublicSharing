<#
.SYNOPSIS
    Get-M365InsiderRiskReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365InsiderRiskReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365InsiderRiskReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365InsiderRiskReport"
...
Write-Log "========== Get-M365InsiderRiskReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365InsiderRiskReport Completed ==========" -Level "SUCCESS"
