<#
.SYNOPSIS
    Get-M365IncidentReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365IncidentReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365IncidentReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365IncidentReport"
...
Write-Log "========== Get-M365IncidentReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365IncidentReport Completed ==========" -Level "SUCCESS"
