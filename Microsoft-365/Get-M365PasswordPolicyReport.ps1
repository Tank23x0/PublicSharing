<#
.SYNOPSIS
    Get-M365PasswordPolicyReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365PasswordPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365PasswordPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365PasswordPolicyReport"
...
Write-Log "========== Get-M365PasswordPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365PasswordPolicyReport Completed ==========" -Level "SUCCESS"
