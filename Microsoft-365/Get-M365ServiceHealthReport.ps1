<#
.SYNOPSIS
    Get-M365ServiceHealthReport.ps1 - Microsoft 365 Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365ServiceHealthReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365ServiceHealthReport"
...
Write-Log "========== Get-M365ServiceHealthReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365ServiceHealthReport Completed ==========" -Level "SUCCESS"
