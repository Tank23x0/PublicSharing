<#
.SYNOPSIS
    Get-M365VivaInsightsReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365VivaInsightsReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365VivaInsightsReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365VivaInsightsReport"
...
Write-Log "========== Get-M365VivaInsightsReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365VivaInsightsReport Completed ==========" -Level "SUCCESS"
