<#
.SYNOPSIS
    Get-M365AppUsageReport.ps1 - Microsoft 365 Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365AppUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365AppUsageReport"
...
Write-Log "========== Get-M365AppUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365AppUsageReport Completed ==========" -Level "SUCCESS"
