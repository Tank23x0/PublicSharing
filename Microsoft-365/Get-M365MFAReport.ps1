<#
.SYNOPSIS
    Get-M365MFAReport.ps1 - Microsoft 365 Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365MFAReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365MFAReport"
...
Write-Log "========== Get-M365MFAReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365MFAReport Completed ==========" -Level "SUCCESS"
