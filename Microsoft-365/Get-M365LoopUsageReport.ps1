<#
.SYNOPSIS
    Get-M365LoopUsageReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365LoopUsageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365LoopUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365LoopUsageReport"
...
Write-Log "========== Get-M365LoopUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365LoopUsageReport Completed ==========" -Level "SUCCESS"
