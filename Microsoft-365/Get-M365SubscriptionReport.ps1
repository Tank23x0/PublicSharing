<#
.SYNOPSIS
    Get-M365SubscriptionReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365SubscriptionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365SubscriptionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365SubscriptionReport"
...
Write-Log "========== Get-M365SubscriptionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365SubscriptionReport Completed ==========" -Level "SUCCESS"
