<#
.SYNOPSIS
    Get-M365OrganizationReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365OrganizationReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365OrganizationReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365OrganizationReport"
...
Write-Log "========== Get-M365OrganizationReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365OrganizationReport Completed ==========" -Level "SUCCESS"
