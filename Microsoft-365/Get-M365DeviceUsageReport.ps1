<#
.SYNOPSIS
    Get-M365DeviceUsageReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365DeviceUsageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365DeviceUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365DeviceUsageReport"
...
Write-Log "========== Get-M365DeviceUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365DeviceUsageReport Completed ==========" -Level "SUCCESS"
