<#
.SYNOPSIS
    Get-M365ContentSearchReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365ContentSearchReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365ContentSearchReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365ContentSearchReport"
...
Write-Log "========== Get-M365ContentSearchReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365ContentSearchReport Completed ==========" -Level "SUCCESS"
