<#
.SYNOPSIS
    Get-M365SharePointUsageReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365SharePointUsageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365SharePointUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365SharePointUsageReport"
...
Write-Log "========== Get-M365SharePointUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365SharePointUsageReport Completed ==========" -Level "SUCCESS"
