<#
.SYNOPSIS
    Get-M365StreamUsageReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365StreamUsageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365StreamUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365StreamUsageReport"
...
Write-Log "========== Get-M365StreamUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365StreamUsageReport Completed ==========" -Level "SUCCESS"
