<#
.SYNOPSIS
    Get-M365AuditLogReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365AuditLogReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365AuditLogReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365AuditLogReport"
...
Write-Log "========== Get-M365AuditLogReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365AuditLogReport Completed ==========" -Level "SUCCESS"
