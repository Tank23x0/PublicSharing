<#
.SYNOPSIS
    Get-M365ActivationReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365ActivationReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365ActivationReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365ActivationReport"
...
Write-Log "========== Get-M365ActivationReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365ActivationReport Completed ==========" -Level "SUCCESS"
