<#
.SYNOPSIS
    Get-M365PowerAppsUsageReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365PowerAppsUsageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365PowerAppsUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365PowerAppsUsageReport"
...
Write-Log "========== Get-M365PowerAppsUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365PowerAppsUsageReport Completed ==========" -Level "SUCCESS"
