<#
.SYNOPSIS
    Get-M365PlannerUsageReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365PlannerUsageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365PlannerUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365PlannerUsageReport"
...
Write-Log "========== Get-M365PlannerUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365PlannerUsageReport Completed ==========" -Level "SUCCESS"
