<#
.SYNOPSIS
    Get-M365CopilotUsageReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365CopilotUsageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365CopilotUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365CopilotUsageReport"
...
Write-Log "========== Get-M365CopilotUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365CopilotUsageReport Completed ==========" -Level "SUCCESS"
