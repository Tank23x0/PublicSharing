<#
.SYNOPSIS
    Get-M365SkypeUsageReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365SkypeUsageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365SkypeUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365SkypeUsageReport"
...
Write-Log "========== Get-M365SkypeUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365SkypeUsageReport Completed ==========" -Level "SUCCESS"
