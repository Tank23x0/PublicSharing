<#
.SYNOPSIS
    Get-M365OneDriveUsageReport.ps1 - Microsoft 365 Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365OneDriveUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365OneDriveUsageReport"
...
Write-Log "========== Get-M365OneDriveUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365OneDriveUsageReport Completed ==========" -Level "SUCCESS"
