<#
.SYNOPSIS
    Get-M365PowerAutomateUsageReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365PowerAutomateUsageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365PowerAutomateUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365PowerAutomateUsageReport"
...
Write-Log "========== Get-M365PowerAutomateUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365PowerAutomateUsageReport Completed ==========" -Level "SUCCESS"
