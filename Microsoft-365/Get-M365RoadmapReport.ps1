<#
.SYNOPSIS
    Get-M365RoadmapReport.ps1 - Microsoft 365 Management Tool
...
.EXAMPLE
    .\Get-M365RoadmapReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-M365RoadmapReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-M365RoadmapReport"
...
Write-Log "========== Get-M365RoadmapReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-M365RoadmapReport Completed ==========" -Level "SUCCESS"
