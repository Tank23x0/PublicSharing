<#
.SYNOPSIS
    Get-PackageProviderReport.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Get-PackageProviderReport.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PackageProviderReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Get-PackageProviderReport"
...
Write-Log "========== Get-PackageProviderReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PackageProviderReport Completed ==========" -Level "SUCCESS"
