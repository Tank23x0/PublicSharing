<#
.SYNOPSIS
    Update-AllModules.ps1 - PowerShell Environment Repair Tool
...
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Update-AllModules_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Update-AllModules"
...
Write-Log "========== Update-AllModules Started ==========" -Level "INFO"
...
Write-Log "========== Update-AllModules Completed ==========" -Level "SUCCESS"
