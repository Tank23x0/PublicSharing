<#
.SYNOPSIS
    Get-PSRemotingReport.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Get-PSRemotingReport.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PSRemotingReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Get-PSRemotingReport"
...
Write-Log "========== Get-PSRemotingReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PSRemotingReport Completed ==========" -Level "SUCCESS"
