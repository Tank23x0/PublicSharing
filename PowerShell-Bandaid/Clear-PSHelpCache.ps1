<#
.SYNOPSIS
    Clear-PSHelpCache.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Clear-PSHelpCache.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Clear-PSHelpCache_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Clear-PSHelpCache"
...
Write-Log "========== Clear-PSHelpCache Started ==========" -Level "INFO"
...
Write-Log "========== Clear-PSHelpCache Completed ==========" -Level "SUCCESS"
