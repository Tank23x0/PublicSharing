<#
.SYNOPSIS
    Get-ModuleConflictReport.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Get-ModuleConflictReport.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ModuleConflictReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Get-ModuleConflictReport"
...
Write-Log "========== Get-ModuleConflictReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ModuleConflictReport Completed ==========" -Level "SUCCESS"
