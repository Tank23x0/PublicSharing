<#
.SYNOPSIS
    Get-PSProfileReport.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Get-PSProfileReport.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PSProfileReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Get-PSProfileReport"
...
Write-Log "========== Get-PSProfileReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PSProfileReport Completed ==========" -Level "SUCCESS"
