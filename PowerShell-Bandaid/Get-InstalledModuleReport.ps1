<#
.SYNOPSIS
    Get-InstalledModuleReport.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Get-InstalledModuleReport.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-InstalledModuleReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Get-InstalledModuleReport"
...
Write-Log "========== Get-InstalledModuleReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-InstalledModuleReport Completed ==========" -Level "SUCCESS"
