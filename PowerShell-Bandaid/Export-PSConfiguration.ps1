<#
.SYNOPSIS
    Export-PSConfiguration.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Export-PSConfiguration.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Export-PSConfiguration_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Export-PSConfiguration"
...
Write-Log "========== Export-PSConfiguration Started ==========" -Level "INFO"
...
Write-Log "========== Export-PSConfiguration Completed ==========" -Level "SUCCESS"
