<#
.SYNOPSIS
    Register-PSRepository.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Register-PSRepository.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Register-PSRepository_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Register-PSRepository"
...
Write-Log "========== Register-PSRepository Started ==========" -Level "INFO"
...
Write-Log "========== Register-PSRepository Completed ==========" -Level "SUCCESS"
