<#
.SYNOPSIS
    Clear-PSResourceCache.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Clear-PSResourceCache.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Clear-PSResourceCache_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Clear-PSResourceCache"
...
Write-Log "========== Clear-PSResourceCache Started ==========" -Level "INFO"
...
Write-Log "========== Clear-PSResourceCache Completed ==========" -Level "SUCCESS"
