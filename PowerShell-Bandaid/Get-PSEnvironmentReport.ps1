<#
.SYNOPSIS
    Get-PSEnvironmentReport.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Get-PSEnvironmentReport.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PSEnvironmentReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Get-PSEnvironmentReport"
...
Write-Log "========== Get-PSEnvironmentReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PSEnvironmentReport Completed ==========" -Level "SUCCESS"
