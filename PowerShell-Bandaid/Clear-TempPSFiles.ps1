<#
.SYNOPSIS
    Clear-TempPSFiles.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Clear-TempPSFiles.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Clear-TempPSFiles_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Clear-TempPSFiles"
...
Write-Log "========== Clear-TempPSFiles Started ==========" -Level "INFO"
...
Write-Log "========== Clear-TempPSFiles Completed ==========" -Level "SUCCESS"
