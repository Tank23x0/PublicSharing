<#
.SYNOPSIS
    Reset-PSDefaults.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Reset-PSDefaults.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Reset-PSDefaults_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Reset-PSDefaults"
...
Write-Log "========== Reset-PSDefaults Started ==========" -Level "INFO"
...
Write-Log "========== Reset-PSDefaults Completed ==========" -Level "SUCCESS"
