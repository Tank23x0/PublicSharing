<#
.SYNOPSIS
    Clear-NuGetCache.ps1 - PowerShell Environment Repair Tool
...
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Clear-NuGetCache_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Clear-NuGetCache"
...
Write-Log "========== Clear-NuGetCache Started ==========" -Level "INFO"
...
Write-Log "========== Clear-NuGetCache Completed ==========" -Level "SUCCESS"
