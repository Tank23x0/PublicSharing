<#
.SYNOPSIS
    Remove-OldModuleVersions.ps1 - PowerShell Environment Repair Tool
...
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Remove-OldModuleVersions_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Remove-OldModuleVersions"
...
Write-Log "========== Remove-OldModuleVersions Started ==========" -Level "INFO"
...
Write-Log "========== Remove-OldModuleVersions Completed ==========" -Level "SUCCESS"
