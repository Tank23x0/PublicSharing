<#
.SYNOPSIS
    Get-ExecutionPolicyReport.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Get-ExecutionPolicyReport.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-ExecutionPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Get-ExecutionPolicyReport"
...
Write-Log "========== Get-ExecutionPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-ExecutionPolicyReport Completed ==========" -Level "SUCCESS"
