<#
.SYNOPSIS
    Get-PSSessionReport.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Get-PSSessionReport.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PSSessionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Get-PSSessionReport"
...
Write-Log "========== Get-PSSessionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PSSessionReport Completed ==========" -Level "SUCCESS"
