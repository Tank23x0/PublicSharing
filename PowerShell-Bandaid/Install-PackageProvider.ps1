<#
.SYNOPSIS
    Install-PackageProvider.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Install-PackageProvider.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Install-PackageProvider_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Install-PackageProvider"
...
Write-Log "========== Install-PackageProvider Started ==========" -Level "INFO"
...
Write-Log "========== Install-PackageProvider Completed ==========" -Level "SUCCESS"
