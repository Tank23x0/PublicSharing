<#
.SYNOPSIS
    Get-PSRepositoryReport.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Get-PSRepositoryReport.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PSRepositoryReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Get-PSRepositoryReport"
...
Write-Log "========== Get-PSRepositoryReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PSRepositoryReport Completed ==========" -Level "SUCCESS"
