<#
.SYNOPSIS
    Import-PSConfiguration.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Import-PSConfiguration.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Import-PSConfiguration_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Import-PSConfiguration"
...
Write-Log "========== Import-PSConfiguration Started ==========" -Level "INFO"
...
Write-Log "========== Import-PSConfiguration Completed ==========" -Level "SUCCESS"
