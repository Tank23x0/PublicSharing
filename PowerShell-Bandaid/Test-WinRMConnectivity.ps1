<#
.SYNOPSIS
    Test-WinRMConnectivity.ps1 - PowerShell Environment Repair Tool
...
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Test-WinRMConnectivity_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Test-WinRMConnectivity"
...
Write-Log "========== Test-WinRMConnectivity Started ==========" -Level "INFO"
...
Write-Log "========== Test-WinRMConnectivity Completed ==========" -Level "SUCCESS"
