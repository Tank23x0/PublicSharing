<#
.SYNOPSIS
    Remove-DuplicateModules.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Remove-DuplicateModules.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Remove-DuplicateModules_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Remove-DuplicateModules"
...
Write-Log "========== Remove-DuplicateModules Started ==========" -Level "INFO"
...
Write-Log "========== Remove-DuplicateModules Completed ==========" -Level "SUCCESS"
