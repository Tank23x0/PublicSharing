<#
.SYNOPSIS
    Enable-PSRemoting.ps1 - PowerShell Environment Repair Tool
...
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Enable-PSRemoting_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Enable-PSRemoting"
...
Write-Log "========== Enable-PSRemoting Started ==========" -Level "INFO"
...
Write-Log "========== Enable-PSRemoting Completed ==========" -Level "SUCCESS"
