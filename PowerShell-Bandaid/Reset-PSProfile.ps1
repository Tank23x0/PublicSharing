<#
.SYNOPSIS
    Reset-PSProfile.ps1 - PowerShell Environment Repair Tool
...
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Reset-PSProfile_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Reset-PSProfile"
...
Write-Log "========== Reset-PSProfile Started ==========" -Level "INFO"
...
Write-Log "========== Reset-PSProfile Completed ==========" -Level "SUCCESS"
