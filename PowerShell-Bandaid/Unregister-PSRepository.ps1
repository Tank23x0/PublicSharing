<#
.SYNOPSIS
    Unregister-PSRepository.ps1 - PowerShell Environment Repair Tool
...
.EXAMPLE
    .\Unregister-PSRepository.ps1
#>

[CmdletBinding(SupportsShouldProcess)]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Unregister-PSRepository_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [switch]$Force
)

$ScriptName = "Unregister-PSRepository"
...
Write-Log "========== Unregister-PSRepository Started ==========" -Level "INFO"
...
Write-Log "========== Unregister-PSRepository Completed ==========" -Level "SUCCESS"
