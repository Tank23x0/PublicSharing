<#
.SYNOPSIS
    Get-AzureNetworkReport.ps1 - Azure NetworkReport Tool
...
.EXAMPLE
    .\Get-AzureNetworkReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AzureNetworkReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-AzureNetworkReport"
...
Write-Host @"
╔══════════════════════════════════════════════════════════════════╗
║              AZURE NetworkReport TOOL                                  ║
╚══════════════════════════════════════════════════════════════════╝
"@ -ForegroundColor Cyan

Write-Log "========== NetworkReport Started ==========" -Level "INFO"
...
Write-Log "========== NetworkReport Completed ==========" -Level "SUCCESS"
