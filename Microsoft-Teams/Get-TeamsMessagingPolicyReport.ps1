<#
.SYNOPSIS
    Get-TeamsMessagingPolicyReport.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsMessagingPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsMessagingPolicyReport"
...
Write-Log "========== Get-TeamsMessagingPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsMessagingPolicyReport Completed ==========" -Level "SUCCESS"
