<#
.SYNOPSIS
    Get-TeamsCallQualityReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsCallQualityReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsCallQualityReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsCallQualityReport"
...
Write-Log "========== Get-TeamsCallQualityReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsCallQualityReport Completed ==========" -Level "SUCCESS"
