<#
.SYNOPSIS
    Get-TeamsGuestAccessReport.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsGuestAccessReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsGuestAccessReport"
...
Write-Log "========== Get-TeamsGuestAccessReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsGuestAccessReport Completed ==========" -Level "SUCCESS"
