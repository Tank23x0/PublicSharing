<#
.SYNOPSIS
    Remove-TeamsUser.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Remove-TeamsUser.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Remove-TeamsUser_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Remove-TeamsUser"
...
Write-Log "========== Remove-TeamsUser Started ==========" -Level "INFO"
...
Write-Log "========== Remove-TeamsUser Completed ==========" -Level "SUCCESS"
