<#
.SYNOPSIS
    Get-TeamsAppPermissionReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsAppPermissionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsAppPermissionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsAppPermissionReport"
...
Write-Log "========== Get-TeamsAppPermissionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsAppPermissionReport Completed ==========" -Level "SUCCESS"
