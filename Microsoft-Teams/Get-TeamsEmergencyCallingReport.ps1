<#
.SYNOPSIS
    Get-TeamsEmergencyCallingReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsEmergencyCallingReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsEmergencyCallingReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsEmergencyCallingReport"
...
Write-Log "========== Get-TeamsEmergencyCallingReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsEmergencyCallingReport Completed ==========" -Level "SUCCESS"
