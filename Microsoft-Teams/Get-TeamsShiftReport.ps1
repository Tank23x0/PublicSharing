<#
.SYNOPSIS
    Get-TeamsShiftReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsShiftReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsShiftReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsShiftReport"
...
Write-Log "========== Get-TeamsShiftReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsShiftReport Completed ==========" -Level "SUCCESS"
