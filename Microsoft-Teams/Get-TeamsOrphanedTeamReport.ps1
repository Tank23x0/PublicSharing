<#
.SYNOPSIS
    Get-TeamsOrphanedTeamReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsOrphanedTeamReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsOrphanedTeamReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsOrphanedTeamReport"
...
Write-Log "========== Get-TeamsOrphanedTeamReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsOrphanedTeamReport Completed ==========" -Level "SUCCESS"
