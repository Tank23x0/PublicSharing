<#
.SYNOPSIS
    Get-TeamsRetentionReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsRetentionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsRetentionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsRetentionReport"
...
Write-Log "========== Get-TeamsRetentionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsRetentionReport Completed ==========" -Level "SUCCESS"
