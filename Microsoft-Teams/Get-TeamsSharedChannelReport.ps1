<#
.SYNOPSIS
    Get-TeamsSharedChannelReport.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsSharedChannelReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsSharedChannelReport"
...
Write-Log "========== Get-TeamsSharedChannelReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsSharedChannelReport Completed ==========" -Level "SUCCESS"
