<#
.SYNOPSIS
    New-TeamsTeam.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\New-TeamsTeam_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "New-TeamsTeam"
...
Write-Log "========== New-TeamsTeam Started ==========" -Level "INFO"
...
Write-Log "========== New-TeamsTeam Completed ==========" -Level "SUCCESS"
