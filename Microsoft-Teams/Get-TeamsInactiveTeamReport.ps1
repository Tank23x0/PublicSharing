<#
.SYNOPSIS
    Get-TeamsInactiveTeamReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsInactiveTeamReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsInactiveTeamReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsInactiveTeamReport"
...
Write-Log "========== Get-TeamsInactiveTeamReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsInactiveTeamReport Completed ==========" -Level "SUCCESS"
