<#
.SYNOPSIS
    Get-TeamsMeetingPolicyReport.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsMeetingPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsMeetingPolicyReport"
...
Write-Log "========== Get-TeamsMeetingPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsMeetingPolicyReport Completed ==========" -Level "SUCCESS"
