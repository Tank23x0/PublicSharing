<#
.SYNOPSIS
    Get-TeamsAuditReport.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsAuditReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsAuditReport"
...
Write-Log "========== Get-TeamsAuditReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsAuditReport Completed ==========" -Level "SUCCESS"
