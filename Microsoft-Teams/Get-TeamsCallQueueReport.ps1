<#
.SYNOPSIS
    Get-TeamsCallQueueReport.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsCallQueueReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsCallQueueReport"
...
Write-Log "========== Get-TeamsCallQueueReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsCallQueueReport Completed ==========" -Level "SUCCESS"
