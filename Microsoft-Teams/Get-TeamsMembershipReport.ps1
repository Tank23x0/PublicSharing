<#
.SYNOPSIS
    Get-TeamsMembershipReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsMembershipReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsMembershipReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsMembershipReport"
...
Write-Log "========== Get-TeamsMembershipReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsMembershipReport Completed ==========" -Level "SUCCESS"
