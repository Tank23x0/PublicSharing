<#
.SYNOPSIS
    Set-TeamsSettings.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Set-TeamsSettings.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Set-TeamsSettings_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Set-TeamsSettings"
...
Write-Log "========== Set-TeamsSettings Started ==========" -Level "INFO"
...
Write-Log "========== Set-TeamsSettings Completed ==========" -Level "SUCCESS"
