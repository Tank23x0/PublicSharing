<#
.SYNOPSIS
    Get-TeamsCallParkPolicyReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsCallParkPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsCallParkPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsCallParkPolicyReport"
...
Write-Log "========== Get-TeamsCallParkPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsCallParkPolicyReport Completed ==========" -Level "SUCCESS"
