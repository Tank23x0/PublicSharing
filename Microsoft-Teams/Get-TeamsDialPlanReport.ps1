<#
.SYNOPSIS
    Get-TeamsDialPlanReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsDialPlanReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsDialPlanReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsDialPlanReport"
...
Write-Log "========== Get-TeamsDialPlanReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsDialPlanReport Completed ==========" -Level "SUCCESS"
