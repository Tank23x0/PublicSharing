<#
.SYNOPSIS
    Get-TeamsLiveEventPolicyReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsLiveEventPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsLiveEventPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsLiveEventPolicyReport"
...
Write-Log "========== Get-TeamsLiveEventPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsLiveEventPolicyReport Completed ==========" -Level "SUCCESS"
