<#
.SYNOPSIS
    Get-TeamsSurfaceHubReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsSurfaceHubReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsSurfaceHubReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsSurfaceHubReport"
...
Write-Log "========== Get-TeamsSurfaceHubReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsSurfaceHubReport Completed ==========" -Level "SUCCESS"
