<#
.SYNOPSIS
    Get-TeamsAppReport.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsAppReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsAppReport"
...
Write-Log "========== Get-TeamsAppReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsAppReport Completed ==========" -Level "SUCCESS"
