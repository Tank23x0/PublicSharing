<#
.SYNOPSIS
    Get-TeamsVoiceRoutingReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsVoiceRoutingReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsVoiceRoutingReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsVoiceRoutingReport"
...
Write-Log "========== Get-TeamsVoiceRoutingReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsVoiceRoutingReport Completed ==========" -Level "SUCCESS"
