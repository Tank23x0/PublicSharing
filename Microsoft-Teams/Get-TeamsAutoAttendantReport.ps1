<#
.SYNOPSIS
    Get-TeamsAutoAttendantReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsAutoAttendantReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsAutoAttendantReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsAutoAttendantReport"
...
Write-Log "========== Get-TeamsAutoAttendantReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsAutoAttendantReport Completed ==========" -Level "SUCCESS"
