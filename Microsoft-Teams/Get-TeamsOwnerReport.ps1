<#
.SYNOPSIS
    Get-TeamsOwnerReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsOwnerReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsOwnerReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsOwnerReport"
...
Write-Log "========== Get-TeamsOwnerReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsOwnerReport Completed ==========" -Level "SUCCESS"
