<#
.SYNOPSIS
    Get-TeamsComplianceRecordingReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsComplianceRecordingReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsComplianceRecordingReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsComplianceRecordingReport"
...
Write-Log "========== Get-TeamsComplianceRecordingReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsComplianceRecordingReport Completed ==========" -Level "SUCCESS"
