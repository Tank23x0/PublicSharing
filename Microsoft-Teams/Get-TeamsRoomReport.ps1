<#
.SYNOPSIS
    Get-TeamsRoomReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsRoomReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsRoomReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsRoomReport"
...
Write-Log "========== Get-TeamsRoomReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsRoomReport Completed ==========" -Level "SUCCESS"
