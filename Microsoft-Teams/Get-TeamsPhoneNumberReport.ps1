<#
.SYNOPSIS
    Get-TeamsPhoneNumberReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsPhoneNumberReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsPhoneNumberReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsPhoneNumberReport"
...
Write-Log "========== Get-TeamsPhoneNumberReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsPhoneNumberReport Completed ==========" -Level "SUCCESS"
