<#
.SYNOPSIS
    Get-TeamsTagReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsTagReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsTagReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsTagReport"
...
Write-Log "========== Get-TeamsTagReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsTagReport Completed ==========" -Level "SUCCESS"
