<#
.SYNOPSIS
    Get-TeamsArchiveReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsArchiveReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsArchiveReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsArchiveReport"
...
Write-Log "========== Get-TeamsArchiveReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsArchiveReport Completed ==========" -Level "SUCCESS"
