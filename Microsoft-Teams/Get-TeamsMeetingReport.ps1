<#
.SYNOPSIS
    Get-TeamsMeetingReport.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsMeetingReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsMeetingReport"
...
Write-Log "========== Get-TeamsMeetingReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsMeetingReport Completed ==========" -Level "SUCCESS"
