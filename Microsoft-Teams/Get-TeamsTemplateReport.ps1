<#
.SYNOPSIS
    Get-TeamsTemplateReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsTemplateReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsTemplateReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsTemplateReport"
...
Write-Log "========== Get-TeamsTemplateReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsTemplateReport Completed ==========" -Level "SUCCESS"
