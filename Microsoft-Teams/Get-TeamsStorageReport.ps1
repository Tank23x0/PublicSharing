<#
.SYNOPSIS
    Get-TeamsStorageReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsStorageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsStorageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsStorageReport"
...
Write-Log "========== Get-TeamsStorageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsStorageReport Completed ==========" -Level "SUCCESS"
