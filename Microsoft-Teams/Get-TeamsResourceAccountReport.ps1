<#
.SYNOPSIS
    Get-TeamsResourceAccountReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsResourceAccountReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsResourceAccountReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsResourceAccountReport"
...
Write-Log "========== Get-TeamsResourceAccountReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsResourceAccountReport Completed ==========" -Level "SUCCESS"
