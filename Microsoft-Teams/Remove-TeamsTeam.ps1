<#
.SYNOPSIS
    Remove-TeamsTeam.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Remove-TeamsTeam.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Remove-TeamsTeam_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Remove-TeamsTeam"
...
Write-Log "========== Remove-TeamsTeam Started ==========" -Level "INFO"
...
Write-Log "========== Remove-TeamsTeam Completed ==========" -Level "SUCCESS"
