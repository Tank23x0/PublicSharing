<#
.SYNOPSIS
    Get-TeamsCallingPolicyReport.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsCallingPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsCallingPolicyReport"
...
Write-Log "========== Get-TeamsCallingPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsCallingPolicyReport Completed ==========" -Level "SUCCESS"
