<#
.SYNOPSIS
    Get-TeamsFrontlineReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsFrontlineReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsFrontlineReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsFrontlineReport"
...
Write-Log "========== Get-TeamsFrontlineReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsFrontlineReport Completed ==========" -Level "SUCCESS"
