<#
.SYNOPSIS
    Get-TeamsEducationReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsEducationReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsEducationReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsEducationReport"
...
Write-Log "========== Get-TeamsEducationReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsEducationReport Completed ==========" -Level "SUCCESS"
