<#
.SYNOPSIS
    Get-TeamsInventoryReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsInventoryReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsInventoryReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsInventoryReport"
...
Write-Log "========== Get-TeamsInventoryReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsInventoryReport Completed ==========" -Level "SUCCESS"
