<#
.SYNOPSIS
    Get-TeamsUserReport.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsUserReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsUserReport"
...
Write-Log "========== Get-TeamsUserReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsUserReport Completed ==========" -Level "SUCCESS"
