<#
.SYNOPSIS
    Get-TeamsUsageReport.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsUsageReport"
...
Write-Log "========== Get-TeamsUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsUsageReport Completed ==========" -Level "SUCCESS"
