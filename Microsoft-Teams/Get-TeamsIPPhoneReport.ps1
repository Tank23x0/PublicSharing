<#
.SYNOPSIS
    Get-TeamsIPPhoneReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsIPPhoneReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsIPPhoneReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsIPPhoneReport"
...
Write-Log "========== Get-TeamsIPPhoneReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsIPPhoneReport Completed ==========" -Level "SUCCESS"
