<#
.SYNOPSIS
    Get-TeamsPrivateChannelReport.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsPrivateChannelReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsPrivateChannelReport"
...
Write-Log "========== Get-TeamsPrivateChannelReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsPrivateChannelReport Completed ==========" -Level "SUCCESS"
