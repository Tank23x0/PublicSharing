<#
.SYNOPSIS
    Get-TeamsSecurityReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsSecurityReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsSecurityReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsSecurityReport"
...
Write-Log "========== Get-TeamsSecurityReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsSecurityReport Completed ==========" -Level "SUCCESS"
