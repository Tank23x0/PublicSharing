<#
.SYNOPSIS
    Get-TeamsDeviceReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsDeviceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsDeviceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsDeviceReport"
...
Write-Log "========== Get-TeamsDeviceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsDeviceReport Completed ==========" -Level "SUCCESS"
