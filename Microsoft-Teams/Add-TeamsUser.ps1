<#
.SYNOPSIS
    Add-TeamsUser.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Add-TeamsUser_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Add-TeamsUser"
...
Write-Log "========== Add-TeamsUser Started ==========" -Level "INFO"
...
Write-Log "========== Add-TeamsUser Completed ==========" -Level "SUCCESS"
