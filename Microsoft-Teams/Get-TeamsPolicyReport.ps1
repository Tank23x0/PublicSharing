<#
.SYNOPSIS
    Get-TeamsPolicyReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsPolicyReport"
...
Write-Log "========== Get-TeamsPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsPolicyReport Completed ==========" -Level "SUCCESS"
