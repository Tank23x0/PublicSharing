<#
.SYNOPSIS
    Get-TeamsSettingsReport.ps1 - Microsoft Teams Management Tool
...
.EXAMPLE
    .\Get-TeamsSettingsReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsSettingsReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsSettingsReport"
...
Write-Log "========== Get-TeamsSettingsReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsSettingsReport Completed ==========" -Level "SUCCESS"
