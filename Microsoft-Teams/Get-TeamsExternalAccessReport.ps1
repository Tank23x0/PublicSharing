<#
.SYNOPSIS
    Get-TeamsExternalAccessReport.ps1 - Microsoft Teams Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-TeamsExternalAccessReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-TeamsExternalAccessReport"
...
Write-Log "========== Get-TeamsExternalAccessReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-TeamsExternalAccessReport Completed ==========" -Level "SUCCESS"
