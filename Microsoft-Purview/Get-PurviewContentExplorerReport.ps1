<#
.SYNOPSIS
    Get-PurviewContentExplorerReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewContentExplorerReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewContentExplorerReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewContentExplorerReport"
...
Write-Log "========== Get-PurviewContentExplorerReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewContentExplorerReport Completed ==========" -Level "SUCCESS"
