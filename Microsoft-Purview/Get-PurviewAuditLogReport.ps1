<#
.SYNOPSIS
    Get-PurviewAuditLogReport.ps1 - Microsoft Purview Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewAuditLogReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewAuditLogReport"
...
Write-Log "========== Get-PurviewAuditLogReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewAuditLogReport Completed ==========" -Level "SUCCESS"
