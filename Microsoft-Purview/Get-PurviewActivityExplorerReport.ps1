<#
.SYNOPSIS
    Get-PurviewActivityExplorerReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewActivityExplorerReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewActivityExplorerReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewActivityExplorerReport"
...
Write-Log "========== Get-PurviewActivityExplorerReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewActivityExplorerReport Completed ==========" -Level "SUCCESS"
