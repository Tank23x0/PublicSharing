<#
.SYNOPSIS
    Set-PurviewDLPPolicy.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Set-PurviewDLPPolicy.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Set-PurviewDLPPolicy_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Set-PurviewDLPPolicy"
...
Write-Log "========== Set-PurviewDLPPolicy Started ==========" -Level "INFO"
...
Write-Log "========== Set-PurviewDLPPolicy Completed ==========" -Level "SUCCESS"
