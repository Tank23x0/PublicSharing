<#
.SYNOPSIS
    Get-PurviewComplianceScoreReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewComplianceScoreReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewComplianceScoreReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewComplianceScoreReport"
...
Write-Log "========== Get-PurviewComplianceScoreReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewComplianceScoreReport Completed ==========" -Level "SUCCESS"
