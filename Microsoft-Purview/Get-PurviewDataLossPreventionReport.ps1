<#
.SYNOPSIS
    Get-PurviewDataLossPreventionReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewDataLossPreventionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewDataLossPreventionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewDataLossPreventionReport"
...
Write-Log "========== Get-PurviewDataLossPreventionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewDataLossPreventionReport Completed ==========" -Level "SUCCESS"
