<#
.SYNOPSIS
    Get-PurviewOneDriveDLPReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewOneDriveDLPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewOneDriveDLPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewOneDriveDLPReport"
...
Write-Log "========== Get-PurviewOneDriveDLPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewOneDriveDLPReport Completed ==========" -Level "SUCCESS"
