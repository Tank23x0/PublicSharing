<#
.SYNOPSIS
    Get-PurviewAdaptiveScopeReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewAdaptiveScopeReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewAdaptiveScopeReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewAdaptiveScopeReport"
...
Write-Log "========== Get-PurviewAdaptiveScopeReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewAdaptiveScopeReport Completed ==========" -Level "SUCCESS"
