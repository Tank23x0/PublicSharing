<#
.SYNOPSIS
    Get-PurviewDataSourceReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewDataSourceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewDataSourceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewDataSourceReport"
...
Write-Log "========== Get-PurviewDataSourceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewDataSourceReport Completed ==========" -Level "SUCCESS"
