<#
.SYNOPSIS
    Get-PurviewDataClassificationReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewDataClassificationReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewDataClassificationReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewDataClassificationReport"
...
Write-Log "========== Get-PurviewDataClassificationReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewDataClassificationReport Completed ==========" -Level "SUCCESS"
