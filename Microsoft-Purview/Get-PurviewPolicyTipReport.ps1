<#
.SYNOPSIS
    Get-PurviewPolicyTipReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewPolicyTipReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewPolicyTipReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewPolicyTipReport"
...
Write-Log "========== Get-PurviewPolicyTipReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewPolicyTipReport Completed ==========" -Level "SUCCESS"
