<#
.SYNOPSIS
    Get-PurviewAlertReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewAlertReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewAlertReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewAlertReport"
...
Write-Log "========== Get-PurviewAlertReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewAlertReport Completed ==========" -Level "SUCCESS"
