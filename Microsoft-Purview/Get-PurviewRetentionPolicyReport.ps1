<#
.SYNOPSIS
    Get-PurviewRetentionPolicyReport.ps1 - Microsoft Purview Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewRetentionPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewRetentionPolicyReport"
...
Write-Log "========== Get-PurviewRetentionPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewRetentionPolicyReport Completed ==========" -Level "SUCCESS"
