<#
.SYNOPSIS
    Get-PurviewConnectorReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewConnectorReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewConnectorReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewConnectorReport"
...
Write-Log "========== Get-PurviewConnectorReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewConnectorReport Completed ==========" -Level "SUCCESS"
