<#
.SYNOPSIS
    Get-PurviewInformationBarrierReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewInformationBarrierReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewInformationBarrierReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewInformationBarrierReport"
...
Write-Log "========== Get-PurviewInformationBarrierReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewInformationBarrierReport Completed ==========" -Level "SUCCESS"
