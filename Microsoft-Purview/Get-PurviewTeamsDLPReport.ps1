<#
.SYNOPSIS
    Get-PurviewTeamsDLPReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewTeamsDLPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewTeamsDLPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewTeamsDLPReport"
...
Write-Log "========== Get-PurviewTeamsDLPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewTeamsDLPReport Completed ==========" -Level "SUCCESS"
