<#
.SYNOPSIS
    Get-PurviewFileplanReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewFileplanReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewFileplanReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewFileplanReport"
...
Write-Log "========== Get-PurviewFileplanReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewFileplanReport Completed ==========" -Level "SUCCESS"
