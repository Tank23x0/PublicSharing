<#
.SYNOPSIS
    Get-PurviewGlossaryReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewGlossaryReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewGlossaryReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewGlossaryReport"
...
Write-Log "========== Get-PurviewGlossaryReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewGlossaryReport Completed ==========" -Level "SUCCESS"
