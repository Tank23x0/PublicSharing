<#
.SYNOPSIS
    Get-PurviewDataMapReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewDataMapReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewDataMapReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewDataMapReport"
...
Write-Log "========== Get-PurviewDataMapReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewDataMapReport Completed ==========" -Level "SUCCESS"
