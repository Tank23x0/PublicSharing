<#
.SYNOPSIS
    Export-PurviewAuditLog.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Export-PurviewAuditLog.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Export-PurviewAuditLog_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Export-PurviewAuditLog"
...
Write-Log "========== Export-PurviewAuditLog Started ==========" -Level "INFO"
...
Write-Log "========== Export-PurviewAuditLog Completed ==========" -Level "SUCCESS"
