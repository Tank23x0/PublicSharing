<#
.SYNOPSIS
    Get-PurviewLabelActivityReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewLabelActivityReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewLabelActivityReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewLabelActivityReport"
...
Write-Log "========== Get-PurviewLabelActivityReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewLabelActivityReport Completed ==========" -Level "SUCCESS"
