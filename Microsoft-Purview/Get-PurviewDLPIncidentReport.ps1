<#
.SYNOPSIS
    Get-PurviewDLPIncidentReport.ps1 - Microsoft Purview Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewDLPIncidentReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewDLPIncidentReport"
...
Write-Log "========== Get-PurviewDLPIncidentReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewDLPIncidentReport Completed ==========" -Level "SUCCESS"
