<#
.SYNOPSIS
    Get-PurviewSharePointDLPReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewSharePointDLPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewSharePointDLPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewSharePointDLPReport"
...
Write-Log "========== Get-PurviewSharePointDLPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewSharePointDLPReport Completed ==========" -Level "SUCCESS"
