<#
.SYNOPSIS
    Get-PurviewDeviceDLPReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewDeviceDLPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewDeviceDLPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewDeviceDLPReport"
...
Write-Log "========== Get-PurviewDeviceDLPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewDeviceDLPReport Completed ==========" -Level "SUCCESS"
