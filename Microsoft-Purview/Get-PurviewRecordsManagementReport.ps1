<#
.SYNOPSIS
    Get-PurviewRecordsManagementReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewRecordsManagementReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewRecordsManagementReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewRecordsManagementReport"
...
Write-Log "========== Get-PurviewRecordsManagementReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewRecordsManagementReport Completed ==========" -Level "SUCCESS"
