<#
.SYNOPSIS
    Get-PurviewCommunicationComplianceReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewCommunicationComplianceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewCommunicationComplianceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewCommunicationComplianceReport"
...
Write-Log "========== Get-PurviewCommunicationComplianceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewCommunicationComplianceReport Completed ==========" -Level "SUCCESS"
