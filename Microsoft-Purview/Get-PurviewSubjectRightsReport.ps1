<#
.SYNOPSIS
    Get-PurviewSubjectRightsReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewSubjectRightsReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewSubjectRightsReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewSubjectRightsReport"
...
Write-Log "========== Get-PurviewSubjectRightsReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewSubjectRightsReport Completed ==========" -Level "SUCCESS"
