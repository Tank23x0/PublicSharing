<#
.SYNOPSIS
    Get-PurviewRetentionLabelReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewRetentionLabelReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewRetentionLabelReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewRetentionLabelReport"
...
Write-Log "========== Get-PurviewRetentionLabelReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewRetentionLabelReport Completed ==========" -Level "SUCCESS"
