<#
.SYNOPSIS
    Get-PurviewClassificationRuleReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewClassificationRuleReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewClassificationRuleReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewClassificationRuleReport"
...
Write-Log "========== Get-PurviewClassificationRuleReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewClassificationRuleReport Completed ==========" -Level "SUCCESS"
