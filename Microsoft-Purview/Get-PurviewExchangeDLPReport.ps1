<#
.SYNOPSIS
    Get-PurviewExchangeDLPReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewExchangeDLPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewExchangeDLPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewExchangeDLPReport"
...
Write-Log "========== Get-PurviewExchangeDLPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewExchangeDLPReport Completed ==========" -Level "SUCCESS"
