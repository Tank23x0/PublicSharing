<#
.SYNOPSIS
    Get-PurviewLabelAnalyticsReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewLabelAnalyticsReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewLabelAnalyticsReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewLabelAnalyticsReport"
...
Write-Log "========== Get-PurviewLabelAnalyticsReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewLabelAnalyticsReport Completed ==========" -Level "SUCCESS"
