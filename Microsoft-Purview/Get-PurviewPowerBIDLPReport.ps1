<#
.SYNOPSIS
    Get-PurviewPowerBIDLPReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewPowerBIDLPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewPowerBIDLPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewPowerBIDLPReport"
...
Write-Log "========== Get-PurviewPowerBIDLPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewPowerBIDLPReport Completed ==========" -Level "SUCCESS"
