<#
.SYNOPSIS
    Get-PurviewBrowserDLPReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewBrowserDLPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewBrowserDLPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewBrowserDLPReport"
...
Write-Log "========== Get-PurviewBrowserDLPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewBrowserDLPReport Completed ==========" -Level "SUCCESS"
