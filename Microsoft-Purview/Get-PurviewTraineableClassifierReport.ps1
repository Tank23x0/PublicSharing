<#
.SYNOPSIS
    Get-PurviewTraineableClassifierReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewTraineableClassifierReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewTraineableClassifierReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewTraineableClassifierReport"
...
Write-Log "========== Get-PurviewTraineableClassifierReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewTraineableClassifierReport Completed ==========" -Level "SUCCESS"
