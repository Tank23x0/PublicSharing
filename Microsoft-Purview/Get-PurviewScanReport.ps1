<#
.SYNOPSIS
    Get-PurviewScanReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewScanReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewScanReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewScanReport"
...
Write-Log "========== Get-PurviewScanReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewScanReport Completed ==========" -Level "SUCCESS"
