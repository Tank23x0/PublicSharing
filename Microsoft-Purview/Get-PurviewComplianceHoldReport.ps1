<#
.SYNOPSIS
    Get-PurviewComplianceHoldReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewComplianceHoldReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewComplianceHoldReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewComplianceHoldReport"
...
Write-Log "========== Get-PurviewComplianceHoldReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewComplianceHoldReport Completed ==========" -Level "SUCCESS"
