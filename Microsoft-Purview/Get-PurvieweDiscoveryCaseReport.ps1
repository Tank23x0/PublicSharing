<#
.SYNOPSIS
    Get-PurvieweDiscoveryCaseReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurvieweDiscoveryCaseReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurvieweDiscoveryCaseReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurvieweDiscoveryCaseReport"
...
Write-Log "========== Get-PurvieweDiscoveryCaseReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurvieweDiscoveryCaseReport Completed ==========" -Level "SUCCESS"
