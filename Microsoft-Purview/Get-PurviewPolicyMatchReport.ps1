<#
.SYNOPSIS
    Get-PurviewPolicyMatchReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewPolicyMatchReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewPolicyMatchReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewPolicyMatchReport"
...
Write-Log "========== Get-PurviewPolicyMatchReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewPolicyMatchReport Completed ==========" -Level "SUCCESS"
