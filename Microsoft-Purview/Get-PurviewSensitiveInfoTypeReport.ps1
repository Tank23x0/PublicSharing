<#
.SYNOPSIS
    Get-PurviewSensitiveInfoTypeReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewSensitiveInfoTypeReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewSensitiveInfoTypeReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewSensitiveInfoTypeReport"
...
Write-Log "========== Get-PurviewSensitiveInfoTypeReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewSensitiveInfoTypeReport Completed ==========" -Level "SUCCESS"
