<#
.SYNOPSIS
    Get-PurviewRetentionReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewRetentionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewRetentionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewRetentionReport"
...
Write-Log "========== Get-PurviewRetentionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewRetentionReport Completed ==========" -Level "SUCCESS"
