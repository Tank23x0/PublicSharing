<#
.SYNOPSIS
    Get-PurviewInsiderRiskReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewInsiderRiskReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewInsiderRiskReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewInsiderRiskReport"
...
Write-Log "========== Get-PurviewInsiderRiskReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewInsiderRiskReport Completed ==========" -Level "SUCCESS"
