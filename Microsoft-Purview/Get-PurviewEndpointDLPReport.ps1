<#
.SYNOPSIS
    Get-PurviewEndpointDLPReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewEndpointDLPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewEndpointDLPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewEndpointDLPReport"
...
Write-Log "========== Get-PurviewEndpointDLPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewEndpointDLPReport Completed ==========" -Level "SUCCESS"
