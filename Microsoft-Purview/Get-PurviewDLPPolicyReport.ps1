<#
.SYNOPSIS
    Get-PurviewDLPPolicyReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewDLPPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewDLPPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewDLPPolicyReport"
...
Write-Log "========== Get-PurviewDLPPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewDLPPolicyReport Completed ==========" -Level "SUCCESS"
