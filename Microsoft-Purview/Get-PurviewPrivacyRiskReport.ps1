<#
.SYNOPSIS
    Get-PurviewPrivacyRiskReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewPrivacyRiskReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewPrivacyRiskReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewPrivacyRiskReport"
...
Write-Log "========== Get-PurviewPrivacyRiskReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewPrivacyRiskReport Completed ==========" -Level "SUCCESS"
