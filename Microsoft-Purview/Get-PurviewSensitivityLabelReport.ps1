<#
.SYNOPSIS
    Get-PurviewSensitivityLabelReport.ps1 - Microsoft Purview Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewSensitivityLabelReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewSensitivityLabelReport"
...
Write-Log "========== Get-PurviewSensitivityLabelReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewSensitivityLabelReport Completed ==========" -Level "SUCCESS"
