<#
.SYNOPSIS
    New-PurviewSensitivityLabel.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\New-PurviewSensitivityLabel.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\New-PurviewSensitivityLabel_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "New-PurviewSensitivityLabel"
...
Write-Log "========== New-PurviewSensitivityLabel Started ==========" -Level "INFO"
...
Write-Log "========== New-PurviewSensitivityLabel Completed ==========" -Level "SUCCESS"
