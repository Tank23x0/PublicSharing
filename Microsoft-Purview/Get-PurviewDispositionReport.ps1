<#
.SYNOPSIS
    Get-PurviewDispositionReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewDispositionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewDispositionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewDispositionReport"
...
Write-Log "========== Get-PurviewDispositionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewDispositionReport Completed ==========" -Level "SUCCESS"
