<#
.SYNOPSIS
    Get-PurviewComplianceSearchReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewComplianceSearchReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewComplianceSearchReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewComplianceSearchReport"
...
Write-Log "========== Get-PurviewComplianceSearchReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewComplianceSearchReport Completed ==========" -Level "SUCCESS"
