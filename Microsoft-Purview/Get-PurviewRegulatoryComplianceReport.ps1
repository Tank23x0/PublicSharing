<#
.SYNOPSIS
    Get-PurviewRegulatoryComplianceReport.ps1 - Microsoft Purview Management Tool
...
.EXAMPLE
    .\Get-PurviewRegulatoryComplianceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-PurviewRegulatoryComplianceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-PurviewRegulatoryComplianceReport"
...
Write-Log "========== Get-PurviewRegulatoryComplianceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-PurviewRegulatoryComplianceReport Completed ==========" -Level "SUCCESS"
