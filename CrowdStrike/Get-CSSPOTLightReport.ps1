<#
.SYNOPSIS
    Get-CSSPOTLightReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSSPOTLightReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSSPOTLightReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSSPOTLightReport"
...
Write-Log "========== Get-CSSPOTLightReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSSPOTLightReport Completed ==========" -Level "SUCCESS"
