<#
.SYNOPSIS
    Get-CSActorReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSActorReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSActorReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSActorReport"
...
Write-Log "========== Get-CSActorReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSActorReport Completed ==========" -Level "SUCCESS"
