<#
.SYNOPSIS
    Get-CSPreventionPolicyReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSPreventionPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSPreventionPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSPreventionPolicyReport"
...
Write-Log "========== Get-CSPreventionPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSPreventionPolicyReport Completed ==========" -Level "SUCCESS"
