<#
.SYNOPSIS
    Get-CSReconReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSReconReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSReconReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSReconReport"
...
Write-Log "========== Get-CSReconReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSReconReport Completed ==========" -Level "SUCCESS"
