<#
.SYNOPSIS
    Get-CSDeviceControlPolicyReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSDeviceControlPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSDeviceControlPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSDeviceControlPolicyReport"
...
Write-Log "========== Get-CSDeviceControlPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSDeviceControlPolicyReport Completed ==========" -Level "SUCCESS"
