<#
.SYNOPSIS
    Get-CSProcessReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSProcessReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSProcessReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSProcessReport"
...
Write-Log "========== Get-CSProcessReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSProcessReport Completed ==========" -Level "SUCCESS"
