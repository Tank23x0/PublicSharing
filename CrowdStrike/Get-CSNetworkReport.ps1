<#
.SYNOPSIS
    Get-CSNetworkReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSNetworkReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSNetworkReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSNetworkReport"
...
Write-Log "========== Get-CSNetworkReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSNetworkReport Completed ==========" -Level "SUCCESS"
