<#
.SYNOPSIS
    Get-CSUserReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSUserReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSUserReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSUserReport"
...
Write-Log "========== Get-CSUserReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSUserReport Completed ==========" -Level "SUCCESS"
