<#
.SYNOPSIS
    Get-CSSensorUpdatePolicyReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSSensorUpdatePolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSSensorUpdatePolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSSensorUpdatePolicyReport"
...
Write-Log "========== Get-CSSensorUpdatePolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSSensorUpdatePolicyReport Completed ==========" -Level "SUCCESS"
