<#
.SYNOPSIS
    Get-CSContainmentReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSContainmentReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSContainmentReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSContainmentReport"
...
Write-Log "========== Get-CSContainmentReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSContainmentReport Completed ==========" -Level "SUCCESS"
