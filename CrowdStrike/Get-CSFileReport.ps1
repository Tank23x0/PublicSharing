<#
.SYNOPSIS
    Get-CSFileReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSFileReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSFileReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSFileReport"
...
Write-Log "========== Get-CSFileReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSFileReport Completed ==========" -Level "SUCCESS"
