<#
.SYNOPSIS
    Get-CSIntelReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSIntelReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSIntelReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSIntelReport"
...
Write-Log "========== Get-CSIntelReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSIntelReport Completed ==========" -Level "SUCCESS"
