<#
.SYNOPSIS
    Get-CSIOAExclusionReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSIOAExclusionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSIOAExclusionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSIOAExclusionReport"
...
Write-Log "========== Get-CSIOAExclusionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSIOAExclusionReport Completed ==========" -Level "SUCCESS"
