<#
.SYNOPSIS
    Get-CSOnDemandScanReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSOnDemandScanReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSOnDemandScanReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSOnDemandScanReport"
...
Write-Log "========== Get-CSOnDemandScanReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSOnDemandScanReport Completed ==========" -Level "SUCCESS"
