<#
.SYNOPSIS
    Set-CSContainment.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Set-CSContainment.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Set-CSContainment_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Set-CSContainment"
...
Write-Log "========== Set-CSContainment Started ==========" -Level "INFO"
...
Write-Log "========== Set-CSContainment Completed ==========" -Level "SUCCESS"
