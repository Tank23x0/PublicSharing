<#
.SYNOPSIS
    Get-CSPlatformReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSPlatformReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSPlatformReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSPlatformReport"
...
Write-Log "========== Get-CSPlatformReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSPlatformReport Completed ==========" -Level "SUCCESS"
