<#
.SYNOPSIS
    Get-CSGroupReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSGroupReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSGroupReport"
...
Write-Log "========== Get-CSGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSGroupReport Completed ==========" -Level "SUCCESS"
