<#
.SYNOPSIS
    Set-CSHostGroup.ps1 - CrowdStrike Falcon Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Set-CSHostGroup_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Set-CSHostGroup"
...
Write-Log "========== Set-CSHostGroup Started ==========" -Level "INFO"
...
Write-Log "========== Set-CSHostGroup Completed ==========" -Level "SUCCESS"
