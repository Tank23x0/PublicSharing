<#
.SYNOPSIS
    Get-CSIOCReport.ps1 - CrowdStrike Falcon Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSIOCReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSIOCReport"
...
Write-Log "========== Get-CSIOCReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSIOCReport Completed ==========" -Level "SUCCESS"
