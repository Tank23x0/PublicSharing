<#
.SYNOPSIS
    Start-CSRTRSession.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Start-CSRTRSession.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Start-CSRTRSession_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Start-CSRTRSession"
...
Write-Log "========== Start-CSRTRSession Started ==========" -Level "INFO"
...
Write-Log "========== Start-CSRTRSession Completed ==========" -Level "SUCCESS"
