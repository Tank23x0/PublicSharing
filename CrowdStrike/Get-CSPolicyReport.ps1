<#
.SYNOPSIS
    Get-CSPolicyReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSPolicyReport"
...
Write-Log "========== Get-CSPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSPolicyReport Completed ==========" -Level "SUCCESS"
