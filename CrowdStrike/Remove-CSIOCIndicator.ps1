<#
.SYNOPSIS
    Remove-CSIOCIndicator.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Remove-CSIOCIndicator.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Remove-CSIOCIndicator_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Remove-CSIOCIndicator"
...
Write-Log "========== Remove-CSIOCIndicator Started ==========" -Level "INFO"
...
Write-Log "========== Remove-CSIOCIndicator Completed ==========" -Level "SUCCESS"
