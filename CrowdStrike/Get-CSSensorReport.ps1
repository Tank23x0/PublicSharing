<#
.SYNOPSIS
    Get-CSSensorReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSSensorReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSSensorReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSSensorReport"
...
Write-Log "========== Get-CSSensorReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSSensorReport Completed ==========" -Level "SUCCESS"
