<#
.SYNOPSIS
    Get-CSHostReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSHostReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSHostReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSHostReport"
...
Write-Log "========== Get-CSHostReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSHostReport Completed ==========" -Level "SUCCESS"
