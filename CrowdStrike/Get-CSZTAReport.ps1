<#
.SYNOPSIS
    Get-CSZTAReport.ps1 - CrowdStrike Falcon Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSZTAReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSZTAReport"
...
Write-Log "========== Get-CSZTAReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSZTAReport Completed ==========" -Level "SUCCESS"
