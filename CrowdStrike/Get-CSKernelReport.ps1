<#
.SYNOPSIS
    Get-CSKernelReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSKernelReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSKernelReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSKernelReport"
...
Write-Log "========== Get-CSKernelReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSKernelReport Completed ==========" -Level "SUCCESS"
