<#
.SYNOPSIS
    Get-CSFirewallPolicyReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSFirewallPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSFirewallPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSFirewallPolicyReport"
...
Write-Log "========== Get-CSFirewallPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSFirewallPolicyReport Completed ==========" -Level "SUCCESS"
