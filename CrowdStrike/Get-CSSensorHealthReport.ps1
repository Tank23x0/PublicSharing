<#
.SYNOPSIS
    Get-CSSensorHealthReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSSensorHealthReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSSensorHealthReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSSensorHealthReport"
...
Write-Log "========== Get-CSSensorHealthReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSSensorHealthReport Completed ==========" -Level "SUCCESS"
