<#
.SYNOPSIS
    Get-CSRegistryReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSRegistryReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSRegistryReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSRegistryReport"
...
Write-Log "========== Get-CSRegistryReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSRegistryReport Completed ==========" -Level "SUCCESS"
