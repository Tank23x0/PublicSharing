<#
.SYNOPSIS
    Get-CSSVExclusionReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSSVExclusionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSSVExclusionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSSVExclusionReport"
...
Write-Log "========== Get-CSSVExclusionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSSVExclusionReport Completed ==========" -Level "SUCCESS"
