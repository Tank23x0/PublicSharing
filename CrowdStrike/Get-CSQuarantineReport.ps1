<#
.SYNOPSIS
    Get-CSQuarantineReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSQuarantineReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSQuarantineReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSQuarantineReport"
...
Write-Log "========== Get-CSQuarantineReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSQuarantineReport Completed ==========" -Level "SUCCESS"
