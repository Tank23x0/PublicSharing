<#
.SYNOPSIS
    Get-CSAPIAuditReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSAPIAuditReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSAPIAuditReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSAPIAuditReport"
...
Write-Log "========== Get-CSAPIAuditReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSAPIAuditReport Completed ==========" -Level "SUCCESS"
