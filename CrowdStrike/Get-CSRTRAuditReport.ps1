<#
.SYNOPSIS
    Get-CSRTRAuditReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSRTRAuditReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSRTRAuditReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSRTRAuditReport"
...
Write-Log "========== Get-CSRTRAuditReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSRTRAuditReport Completed ==========" -Level "SUCCESS"
