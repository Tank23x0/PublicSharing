<#
.SYNOPSIS
    Get-CSIdentityProtectionReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSIdentityProtectionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSIdentityProtectionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSIdentityProtectionReport"
...
Write-Log "========== Get-CSIdentityProtectionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSIdentityProtectionReport Completed ==========" -Level "SUCCESS"
