<#
.SYNOPSIS
    Get-CSIncidentReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSIncidentReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSIncidentReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSIncidentReport"
...
Write-Log "========== Get-CSIncidentReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSIncidentReport Completed ==========" -Level "SUCCESS"
