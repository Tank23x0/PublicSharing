<#
.SYNOPSIS
    Get-CSRTRSessionReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSRTRSessionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSRTRSessionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSRTRSessionReport"
...
Write-Log "========== Get-CSRTRSessionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSRTRSessionReport Completed ==========" -Level "SUCCESS"
