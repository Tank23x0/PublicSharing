<#
.SYNOPSIS
    Get-CSDiscoverReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSDiscoverReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSDiscoverReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSDiscoverReport"
...
Write-Log "========== Get-CSDiscoverReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSDiscoverReport Completed ==========" -Level "SUCCESS"
