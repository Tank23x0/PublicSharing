<#
.SYNOPSIS
    Get-CSMLExclusionReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSMLExclusionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSMLExclusionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSMLExclusionReport"
...
Write-Log "========== Get-CSMLExclusionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSMLExclusionReport Completed ==========" -Level "SUCCESS"
