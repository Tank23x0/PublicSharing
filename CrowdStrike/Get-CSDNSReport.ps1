<#
.SYNOPSIS
    Get-CSDNSReport.ps1 - CrowdStrike Falcon Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSDNSReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSDNSReport"
...
Write-Log "========== Get-CSDNSReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSDNSReport Completed ==========" -Level "SUCCESS"
