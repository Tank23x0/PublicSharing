<#
.SYNOPSIS
    Get-CSResponsePolicyReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSResponsePolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSResponsePolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSResponsePolicyReport"
...
Write-Log "========== Get-CSResponsePolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSResponsePolicyReport Completed ==========" -Level "SUCCESS"
