<#
.SYNOPSIS
    Get-CSHostGroupReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSHostGroupReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSHostGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSHostGroupReport"
...
Write-Log "========== Get-CSHostGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSHostGroupReport Completed ==========" -Level "SUCCESS"
