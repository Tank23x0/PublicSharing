<#
.SYNOPSIS
    Get-CSBehaviorReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSBehaviorReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSBehaviorReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSBehaviorReport"
...
Write-Log "========== Get-CSBehaviorReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSBehaviorReport Completed ==========" -Level "SUCCESS"
