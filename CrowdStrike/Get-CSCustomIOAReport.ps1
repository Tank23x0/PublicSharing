<#
.SYNOPSIS
    Get-CSCustomIOAReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSCustomIOAReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSCustomIOAReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSCustomIOAReport"
...
Write-Log "========== Get-CSCustomIOAReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSCustomIOAReport Completed ==========" -Level "SUCCESS"
