<#
.SYNOPSIS
    Get-CSScheduledSearchReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSScheduledSearchReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSScheduledSearchReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSScheduledSearchReport"
...
Write-Log "========== Get-CSScheduledSearchReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSScheduledSearchReport Completed ==========" -Level "SUCCESS"
