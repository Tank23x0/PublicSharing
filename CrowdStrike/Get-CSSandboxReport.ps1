<#
.SYNOPSIS
    Get-CSSandboxReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSSandboxReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSSandboxReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSSandboxReport"
...
Write-Log "========== Get-CSSandboxReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSSandboxReport Completed ==========" -Level "SUCCESS"
