<#
.SYNOPSIS
    Get-CSQuickScanReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSQuickScanReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSQuickScanReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSQuickScanReport"
...
Write-Log "========== Get-CSQuickScanReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSQuickScanReport Completed ==========" -Level "SUCCESS"
