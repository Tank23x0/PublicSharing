<#
.SYNOPSIS
    Get-CSDetectionReport.ps1 - CrowdStrike Falcon Management Tool
...
.EXAMPLE
    .\Get-CSDetectionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-CSDetectionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ClientId,
    [string]$ClientSecret,
    [string]$Cloud = "us-1"
)

$ScriptName = "Get-CSDetectionReport"
...
Write-Log "========== Get-CSDetectionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-CSDetectionReport Completed ==========" -Level "SUCCESS"
