<#
.SYNOPSIS
    Get-AWSIAMPolicyReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSIAMPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSIAMPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSIAMPolicyReport"
...
Write-Log "========== Get-AWSIAMPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSIAMPolicyReport Completed ==========" -Level "SUCCESS"
