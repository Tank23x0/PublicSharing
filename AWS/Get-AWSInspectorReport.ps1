<#
.SYNOPSIS
    Get-AWSInspectorReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSInspectorReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSInspectorReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSInspectorReport"
...
Write-Log "========== Get-AWSInspectorReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSInspectorReport Completed ==========" -Level "SUCCESS"
