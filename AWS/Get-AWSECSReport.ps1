<#
.SYNOPSIS
    Get-AWSECSReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSECSReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSECSReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSECSReport"
...
Write-Log "========== Get-AWSECSReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSECSReport Completed ==========" -Level "SUCCESS"
