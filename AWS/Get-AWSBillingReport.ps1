<#
.SYNOPSIS
    Get-AWSBillingReport.ps1 - AWS Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSBillingReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSBillingReport"
...
Write-Log "========== Get-AWSBillingReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSBillingReport Completed ==========" -Level "SUCCESS"
