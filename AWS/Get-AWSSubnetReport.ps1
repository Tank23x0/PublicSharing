<#
.SYNOPSIS
    Get-AWSSubnetReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSSubnetReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSSubnetReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSSubnetReport"
...
Write-Log "========== Get-AWSSubnetReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSSubnetReport Completed ==========" -Level "SUCCESS"
