<#
.SYNOPSIS
    Get-AWSSNSReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSSNSReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSSNSReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSSNSReport"
...
Write-Log "========== Get-AWSSNSReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSSNSReport Completed ==========" -Level "SUCCESS"
