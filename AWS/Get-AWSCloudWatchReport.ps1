<#
.SYNOPSIS
    Get-AWSCloudWatchReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSCloudWatchReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSCloudWatchReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSCloudWatchReport"
...
Write-Log "========== Get-AWSCloudWatchReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSCloudWatchReport Completed ==========" -Level "SUCCESS"
