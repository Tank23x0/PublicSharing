<#
.SYNOPSIS
    Enable-AWSMFADevice.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Enable-AWSMFADevice.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Enable-AWSMFADevice_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Enable-AWSMFADevice"
...
Write-Log "========== Enable-AWSMFADevice Started ==========" -Level "INFO"
...
Write-Log "========== Enable-AWSMFADevice Completed ==========" -Level "SUCCESS"
