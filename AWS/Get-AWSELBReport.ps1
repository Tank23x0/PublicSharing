<#
.SYNOPSIS
    Get-AWSELBReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSELBReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSELBReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSELBReport"
...
Write-Log "========== Get-AWSELBReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSELBReport Completed ==========" -Level "SUCCESS"
