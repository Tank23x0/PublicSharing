<#
.SYNOPSIS
    Get-AWSCertificateReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSCertificateReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSCertificateReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSCertificateReport"
...
Write-Log "========== Get-AWSCertificateReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSCertificateReport Completed ==========" -Level "SUCCESS"
