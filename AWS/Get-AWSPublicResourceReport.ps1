<#
.SYNOPSIS
    Get-AWSPublicResourceReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSPublicResourceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSPublicResourceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSPublicResourceReport"
...
Write-Log "========== Get-AWSPublicResourceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSPublicResourceReport Completed ==========" -Level "SUCCESS"
