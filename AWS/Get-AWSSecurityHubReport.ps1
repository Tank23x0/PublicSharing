<#
.SYNOPSIS
    Get-AWSSecurityHubReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSSecurityHubReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSSecurityHubReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSSecurityHubReport"
...
Write-Log "========== Get-AWSSecurityHubReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSSecurityHubReport Completed ==========" -Level "SUCCESS"
