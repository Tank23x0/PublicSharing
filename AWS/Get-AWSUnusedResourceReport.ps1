<#
.SYNOPSIS
    Get-AWSUnusedResourceReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSUnusedResourceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSUnusedResourceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSUnusedResourceReport"
...
Write-Log "========== Get-AWSUnusedResourceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSUnusedResourceReport Completed ==========" -Level "SUCCESS"
