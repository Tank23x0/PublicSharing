<#
.SYNOPSIS
    Get-AWSS3BucketReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSS3BucketReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSS3BucketReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSS3BucketReport"
...
Write-Log "========== Get-AWSS3BucketReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSS3BucketReport Completed ==========" -Level "SUCCESS"
