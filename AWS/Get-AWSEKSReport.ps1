<#
.SYNOPSIS
    Get-AWSEKSReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSEKSReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSEKSReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSEKSReport"
...
Write-Log "========== Get-AWSEKSReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSEKSReport Completed ==========" -Level "SUCCESS"
