<#
.SYNOPSIS
    Get-AWSEC2SecurityGroupReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSEC2SecurityGroupReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSEC2SecurityGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSEC2SecurityGroupReport"
...
Write-Log "========== Get-AWSEC2SecurityGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSEC2SecurityGroupReport Completed ==========" -Level "SUCCESS"
