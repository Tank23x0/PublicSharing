<#
.SYNOPSIS
    Get-AWSRouteTableReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSRouteTableReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSRouteTableReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSRouteTableReport"
...
Write-Log "========== Get-AWSRouteTableReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSRouteTableReport Completed ==========" -Level "SUCCESS"
