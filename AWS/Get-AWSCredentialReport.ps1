<#
.SYNOPSIS
    Get-AWSCredentialReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSCredentialReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSCredentialReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSCredentialReport"
...
Write-Log "========== Get-AWSCredentialReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSCredentialReport Completed ==========" -Level "SUCCESS"
