<#
.SYNOPSIS
    Get-AWSMacieReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSMacieReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSMacieReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSMacieReport"
...
Write-Log "========== Get-AWSMacieReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSMacieReport Completed ==========" -Level "SUCCESS"
