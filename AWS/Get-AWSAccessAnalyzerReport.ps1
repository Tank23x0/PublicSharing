<#
.SYNOPSIS
    Get-AWSAccessAnalyzerReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSAccessAnalyzerReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSAccessAnalyzerReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSAccessAnalyzerReport"
...
Write-Log "========== Get-AWSAccessAnalyzerReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSAccessAnalyzerReport Completed ==========" -Level "SUCCESS"
