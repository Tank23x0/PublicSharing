<#
.SYNOPSIS
    Get-AWSEC2InstanceReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSEC2InstanceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSEC2InstanceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSEC2InstanceReport"
...
Write-Log "========== Get-AWSEC2InstanceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSEC2InstanceReport Completed ==========" -Level "SUCCESS"
