<#
.SYNOPSIS
    Get-AWSWAFReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSWAFReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSWAFReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSWAFReport"
...
Write-Log "========== Get-AWSWAFReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSWAFReport Completed ==========" -Level "SUCCESS"
