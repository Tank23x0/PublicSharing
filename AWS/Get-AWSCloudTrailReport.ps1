<#
.SYNOPSIS
    Get-AWSCloudTrailReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSCloudTrailReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSCloudTrailReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSCloudTrailReport"
...
Write-Log "========== Get-AWSCloudTrailReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSCloudTrailReport Completed ==========" -Level "SUCCESS"
