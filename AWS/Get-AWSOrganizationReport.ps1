<#
.SYNOPSIS
    Get-AWSOrganizationReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSOrganizationReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSOrganizationReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSOrganizationReport"
...
Write-Log "========== Get-AWSOrganizationReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSOrganizationReport Completed ==========" -Level "SUCCESS"
