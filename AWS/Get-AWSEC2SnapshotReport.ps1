<#
.SYNOPSIS
    Get-AWSEC2SnapshotReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSEC2SnapshotReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSEC2SnapshotReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSEC2SnapshotReport"
...
Write-Log "========== Get-AWSEC2SnapshotReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSEC2SnapshotReport Completed ==========" -Level "SUCCESS"
