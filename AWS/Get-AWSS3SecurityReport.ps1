<#
.SYNOPSIS
    Get-AWSS3SecurityReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSS3SecurityReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSS3SecurityReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSS3SecurityReport"
...
Write-Log "========== Get-AWSS3SecurityReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSS3SecurityReport Completed ==========" -Level "SUCCESS"
