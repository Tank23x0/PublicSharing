<#
.SYNOPSIS
    Set-AWSS3BucketPolicy.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Set-AWSS3BucketPolicy.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Set-AWSS3BucketPolicy_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Set-AWSS3BucketPolicy"
...
Write-Log "========== Set-AWSS3BucketPolicy Started ==========" -Level "INFO"
...
Write-Log "========== Set-AWSS3BucketPolicy Completed ==========" -Level "SUCCESS"
