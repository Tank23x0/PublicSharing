<#
.SYNOPSIS
    Get-AWSCostReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSCostReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSCostReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSCostReport"
...
Write-Log "========== Get-AWSCostReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSCostReport Completed ==========" -Level "SUCCESS"
