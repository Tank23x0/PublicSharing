<#
.SYNOPSIS
    Get-AWSInternetGatewayReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSInternetGatewayReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSInternetGatewayReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSInternetGatewayReport"
...
Write-Log "========== Get-AWSInternetGatewayReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSInternetGatewayReport Completed ==========" -Level "SUCCESS"
