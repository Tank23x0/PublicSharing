<#
.SYNOPSIS
    Get-AWSCloudFrontReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSCloudFrontReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSCloudFrontReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSCloudFrontReport"
...
Write-Log "========== Get-AWSCloudFrontReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSCloudFrontReport Completed ==========" -Level "SUCCESS"
