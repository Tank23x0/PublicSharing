<#
.SYNOPSIS
    Get-AWSRDSSecurityReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSRDSSecurityReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSRDSSecurityReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSRDSSecurityReport"
...
Write-Log "========== Get-AWSRDSSecurityReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSRDSSecurityReport Completed ==========" -Level "SUCCESS"
