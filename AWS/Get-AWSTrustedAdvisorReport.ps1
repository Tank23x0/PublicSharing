<#
.SYNOPSIS
    Get-AWSTrustedAdvisorReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSTrustedAdvisorReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSTrustedAdvisorReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSTrustedAdvisorReport"
...
Write-Log "========== Get-AWSTrustedAdvisorReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSTrustedAdvisorReport Completed ==========" -Level "SUCCESS"
