<#
.SYNOPSIS
    Get-AWSAutoScalingReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSAutoScalingReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSAutoScalingReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSAutoScalingReport"
...
Write-Log "========== Get-AWSAutoScalingReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSAutoScalingReport Completed ==========" -Level "SUCCESS"
