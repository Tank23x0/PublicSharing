<#
.SYNOPSIS
    Get-AWSIAMGroupReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSIAMGroupReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSIAMGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSIAMGroupReport"
...
Write-Log "========== Get-AWSIAMGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSIAMGroupReport Completed ==========" -Level "SUCCESS"
