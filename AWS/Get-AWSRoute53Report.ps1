<#
.SYNOPSIS
    Get-AWSRoute53Report.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSRoute53Report.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSRoute53Report_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSRoute53Report"
...
Write-Log "========== Get-AWSRoute53Report Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSRoute53Report Completed ==========" -Level "SUCCESS"
