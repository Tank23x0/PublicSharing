<#
.SYNOPSIS
    Get-AWSVPCReport.ps1 - AWS Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSVPCReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSVPCReport"
...
Write-Log "========== Get-AWSVPCReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSVPCReport Completed ==========" -Level "SUCCESS"
