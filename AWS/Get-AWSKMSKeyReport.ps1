<#
.SYNOPSIS
    Get-AWSKMSKeyReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSKMSKeyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSKMSKeyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSKMSKeyReport"
...
Write-Log "========== Get-AWSKMSKeyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSKMSKeyReport Completed ==========" -Level "SUCCESS"
