<#
.SYNOPSIS
    Get-AWSNATGatewayReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSNATGatewayReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSNATGatewayReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSNATGatewayReport"
...
Write-Log "========== Get-AWSNATGatewayReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSNATGatewayReport Completed ==========" -Level "SUCCESS"
