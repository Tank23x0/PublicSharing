<#
.SYNOPSIS
    Get-AWSIAMUserReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSIAMUserReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSIAMUserReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSIAMUserReport"
...
Write-Log "========== Get-AWSIAMUserReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSIAMUserReport Completed ==========" -Level "SUCCESS"
