<#
.SYNOPSIS
    Get-AWSConfigReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSConfigReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSConfigReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSConfigReport"
...
Write-Log "========== Get-AWSConfigReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSConfigReport Completed ==========" -Level "SUCCESS"
