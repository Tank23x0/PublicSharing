<#
.SYNOPSIS
    Get-AWSResourceTagReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSResourceTagReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSResourceTagReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSResourceTagReport"
...
Write-Log "========== Get-AWSResourceTagReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSResourceTagReport Completed ==========" -Level "SUCCESS"
