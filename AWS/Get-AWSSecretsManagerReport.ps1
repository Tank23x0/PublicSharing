<#
.SYNOPSIS
    Get-AWSSecretsManagerReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSSecretsManagerReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSSecretsManagerReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSSecretsManagerReport"
...
Write-Log "========== Get-AWSSecretsManagerReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSSecretsManagerReport Completed ==========" -Level "SUCCESS"
