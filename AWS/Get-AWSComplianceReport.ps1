<#
.SYNOPSIS
    Get-AWSComplianceReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSComplianceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSComplianceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSComplianceReport"
...
Write-Log "========== Get-AWSComplianceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSComplianceReport Completed ==========" -Level "SUCCESS"
