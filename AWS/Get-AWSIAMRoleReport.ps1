<#
.SYNOPSIS
    Get-AWSIAMRoleReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSIAMRoleReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSIAMRoleReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSIAMRoleReport"
...
Write-Log "========== Get-AWSIAMRoleReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSIAMRoleReport Completed ==========" -Level "SUCCESS"
