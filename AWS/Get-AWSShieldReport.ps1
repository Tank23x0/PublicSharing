<#
.SYNOPSIS
    Get-AWSShieldReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSShieldReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSShieldReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSShieldReport"
...
Write-Log "========== Get-AWSShieldReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSShieldReport Completed ==========" -Level "SUCCESS"
