<#
.SYNOPSIS
    Get-AWSRDSInstanceReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSRDSInstanceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSRDSInstanceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSRDSInstanceReport"
...
Write-Log "========== Get-AWSRDSInstanceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSRDSInstanceReport Completed ==========" -Level "SUCCESS"
