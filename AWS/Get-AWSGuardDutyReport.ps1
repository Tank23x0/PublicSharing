<#
.SYNOPSIS
    Get-AWSGuardDutyReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSGuardDutyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSGuardDutyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSGuardDutyReport"
...
Write-Log "========== Get-AWSGuardDutyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSGuardDutyReport Completed ==========" -Level "SUCCESS"
