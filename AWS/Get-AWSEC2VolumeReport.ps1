<#
.SYNOPSIS
    Get-AWSEC2VolumeReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSEC2VolumeReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSEC2VolumeReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSEC2VolumeReport"
...
Write-Log "========== Get-AWSEC2VolumeReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSEC2VolumeReport Completed ==========" -Level "SUCCESS"
