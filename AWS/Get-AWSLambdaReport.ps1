<#
.SYNOPSIS
    Get-AWSLambdaReport.ps1 - AWS Management Tool
...
.EXAMPLE
    .\Get-AWSLambdaReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-AWSLambdaReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$ProfileName = "default",
    [string]$Region = "us-east-1"
)

$ScriptName = "Get-AWSLambdaReport"
...
Write-Log "========== Get-AWSLambdaReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-AWSLambdaReport Completed ==========" -Level "SUCCESS"
