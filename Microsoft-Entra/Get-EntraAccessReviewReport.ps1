<#
.SYNOPSIS
    Get-EntraAccessReviewReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraAccessReviewReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraAccessReviewReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraAccessReviewReport"
...
Write-Log "========== Get-EntraAccessReviewReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraAccessReviewReport Completed ==========" -Level "SUCCESS"
