<#
.SYNOPSIS
    Get-EntraLicenseReport.ps1 - Microsoft Entra ID Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraLicenseReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraLicenseReport"
...
Write-Log "========== Get-EntraLicenseReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraLicenseReport Completed ==========" -Level "SUCCESS"
