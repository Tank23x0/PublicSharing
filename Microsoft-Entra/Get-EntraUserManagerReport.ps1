<#
.SYNOPSIS
    Get-EntraUserManagerReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraUserManagerReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraUserManagerReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraUserManagerReport"
...
Write-Log "========== Get-EntraUserManagerReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraUserManagerReport Completed ==========" -Level "SUCCESS"
