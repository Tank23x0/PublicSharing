<#
.SYNOPSIS
    Get-EntraSecurityDefaultsReport.ps1 - Microsoft Entra ID Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraSecurityDefaultsReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraSecurityDefaultsReport"
...
Write-Log "========== Get-EntraSecurityDefaultsReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraSecurityDefaultsReport Completed ==========" -Level "SUCCESS"
