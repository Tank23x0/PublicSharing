<#
.SYNOPSIS
    Get-EntraRiskyUserReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraRiskyUserReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraRiskyUserReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraRiskyUserReport"
...
Write-Log "========== Get-EntraRiskyUserReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraRiskyUserReport Completed ==========" -Level "SUCCESS"
