<#
.SYNOPSIS
    Get-EntraTenantReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraTenantReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraTenantReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraTenantReport"
...
Write-Log "========== Get-EntraTenantReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraTenantReport Completed ==========" -Level "SUCCESS"
