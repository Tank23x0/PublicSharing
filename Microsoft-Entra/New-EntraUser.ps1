<#
.SYNOPSIS
    New-EntraUser.ps1 - Microsoft Entra ID Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\New-EntraUser_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)
...
Write-Log "========== New-EntraUser Started ==========" -Level "INFO"
...
Write-Log "========== New-EntraUser Completed ==========" -Level "SUCCESS"
