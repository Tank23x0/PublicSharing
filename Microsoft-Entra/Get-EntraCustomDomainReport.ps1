<#
.SYNOPSIS
    Get-EntraCustomDomainReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraCustomDomainReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraCustomDomainReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraCustomDomainReport"
...
Write-Log "========== Get-EntraCustomDomainReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraCustomDomainReport Completed ==========" -Level "SUCCESS"
