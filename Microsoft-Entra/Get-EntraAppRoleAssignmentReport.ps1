<#
.SYNOPSIS
    Get-EntraAppRoleAssignmentReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraAppRoleAssignmentReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraAppRoleAssignmentReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraAppRoleAssignmentReport"
...
Write-Log "========== Get-EntraAppRoleAssignmentReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraAppRoleAssignmentReport Completed ==========" -Level "SUCCESS"
