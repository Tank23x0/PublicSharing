<#
.SYNOPSIS
    Get-EntraDirectoryRoleReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraDirectoryRoleReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraDirectoryRoleReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraDirectoryRoleReport"
...
Write-Log "========== Get-EntraDirectoryRoleReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraDirectoryRoleReport Completed ==========" -Level "SUCCESS"
