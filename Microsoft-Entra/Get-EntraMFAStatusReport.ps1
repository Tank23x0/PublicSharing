<#
.SYNOPSIS
    Get-EntraMFAStatusReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraMFAStatusReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraMFAStatusReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraMFAStatusReport"
...
Write-Log "========== Get-EntraMFAStatusReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraMFAStatusReport Completed ==========" -Level "SUCCESS"
