<#
.SYNOPSIS
    Get-EntraUserReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraUserReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraUserReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)
...
Write-Log "========== Get-EntraUserReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraUserReport Completed ==========" -Level "SUCCESS"
