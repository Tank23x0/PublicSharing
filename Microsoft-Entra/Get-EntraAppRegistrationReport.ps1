<#
.SYNOPSIS
    Get-EntraAppRegistrationReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraAppRegistrationReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraAppRegistrationReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraAppRegistrationReport"
...
Write-Log "========== Get-EntraAppRegistrationReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraAppRegistrationReport Completed ==========" -Level "SUCCESS"
