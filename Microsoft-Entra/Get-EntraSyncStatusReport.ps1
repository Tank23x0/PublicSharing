<#
.SYNOPSIS
    Get-EntraSyncStatusReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraSyncStatusReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraSyncStatusReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraSyncStatusReport"
...
Write-Log "========== Get-EntraSyncStatusReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraSyncStatusReport Completed ==========" -Level "SUCCESS"
