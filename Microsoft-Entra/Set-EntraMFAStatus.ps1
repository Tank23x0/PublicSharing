<#
.SYNOPSIS
    Set-EntraMFAStatus.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Set-EntraMFAStatus.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Set-EntraMFAStatus_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Set-EntraMFAStatus"
...
Write-Log "========== Set-EntraMFAStatus Started ==========" -Level "INFO"
...
Write-Log "========== Set-EntraMFAStatus Completed ==========" -Level "SUCCESS"
