<#
.SYNOPSIS
    Disable-EntraUser.ps1 - Microsoft Entra ID Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Disable-EntraUser_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Disable-EntraUser"
...
Write-Log "========== Disable-EntraUser Started ==========" -Level "INFO"
...
Write-Log "========== Disable-EntraUser Completed ==========" -Level "SUCCESS"
