<#
.SYNOPSIS
    Get-EntraGuestUserReport.ps1 - Microsoft Entra ID Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraGuestUserReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraGuestUserReport"
...
Write-Log "========== Get-EntraGuestUserReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraGuestUserReport Completed ==========" -Level "SUCCESS"
