<#
.SYNOPSIS
    Get-EntraSignInReport.ps1 - Microsoft Entra ID Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraSignInReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraSignInReport"
...
Write-Log "========== Get-EntraSignInReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraSignInReport Completed ==========" -Level "SUCCESS"
