<#
.SYNOPSIS
    Get-EntraAuthMethodReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraAuthMethodReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraAuthMethodReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraAuthMethodReport"
...
Write-Log "========== Get-EntraAuthMethodReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraAuthMethodReport Completed ==========" -Level "SUCCESS"
