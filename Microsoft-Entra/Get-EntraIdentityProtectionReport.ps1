<#
.SYNOPSIS
    Get-EntraIdentityProtectionReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraIdentityProtectionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraIdentityProtectionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraIdentityProtectionReport"
...
Write-Log "========== Get-EntraIdentityProtectionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraIdentityProtectionReport Completed ==========" -Level "SUCCESS"
