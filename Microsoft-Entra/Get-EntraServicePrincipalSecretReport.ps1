<#
.SYNOPSIS
    Get-EntraServicePrincipalSecretReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraServicePrincipalSecretReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraServicePrincipalSecretReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraServicePrincipalSecretReport"
...
Write-Log "========== Get-EntraServicePrincipalSecretReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraServicePrincipalSecretReport Completed ==========" -Level "SUCCESS"
