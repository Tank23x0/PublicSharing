<#
.SYNOPSIS
    Get-EntraSecurityReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraSecurityReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraSecurityReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraSecurityReport"
...
Write-Log "========== Get-EntraSecurityReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraSecurityReport Completed ==========" -Level "SUCCESS"
