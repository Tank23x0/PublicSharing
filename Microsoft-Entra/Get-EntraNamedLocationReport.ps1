<#
.SYNOPSIS
    Get-EntraNamedLocationReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraNamedLocationReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraNamedLocationReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraNamedLocationReport"
...
Write-Log "========== Get-EntraNamedLocationReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraNamedLocationReport Completed ==========" -Level "SUCCESS"
