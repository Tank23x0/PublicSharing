<#
.SYNOPSIS
    Get-EntraPrivilegedIdentityReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraPrivilegedIdentityReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraPrivilegedIdentityReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraPrivilegedIdentityReport"
...
Write-Log "========== Get-EntraPrivilegedIdentityReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraPrivilegedIdentityReport Completed ==========" -Level "SUCCESS"
