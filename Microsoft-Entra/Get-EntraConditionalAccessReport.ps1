<#
.SYNOPSIS
    Get-EntraConditionalAccessReport.ps1 - Microsoft Entra ID Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraConditionalAccessReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraConditionalAccessReport"
...
Write-Log "========== Get-EntraConditionalAccessReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraConditionalAccessReport Completed ==========" -Level "SUCCESS"
