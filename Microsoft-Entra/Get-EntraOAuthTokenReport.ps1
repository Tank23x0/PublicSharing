<#
.SYNOPSIS
    Get-EntraOAuthTokenReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraOAuthTokenReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraOAuthTokenReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraOAuthTokenReport"
...
Write-Log "========== Get-EntraOAuthTokenReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraOAuthTokenReport Completed ==========" -Level "SUCCESS"
