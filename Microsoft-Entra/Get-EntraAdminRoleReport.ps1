<#
.SYNOPSIS
    Get-EntraAdminRoleReport.ps1 - Microsoft Entra ID Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraAdminRoleReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraAdminRoleReport"
...
Write-Log "========== Get-EntraAdminRoleReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraAdminRoleReport Completed ==========" -Level "SUCCESS"
