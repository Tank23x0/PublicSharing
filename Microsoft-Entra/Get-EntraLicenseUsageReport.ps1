<#
.SYNOPSIS
    Get-EntraLicenseUsageReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraLicenseUsageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraLicenseUsageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraLicenseUsageReport"
...
Write-Log "========== Get-EntraLicenseUsageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraLicenseUsageReport Completed ==========" -Level "SUCCESS"
