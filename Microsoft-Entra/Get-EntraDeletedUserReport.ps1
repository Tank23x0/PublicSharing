<#
.SYNOPSIS
    Get-EntraDeletedUserReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraDeletedUserReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraDeletedUserReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraDeletedUserReport"
...
Write-Log "========== Get-EntraDeletedUserReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraDeletedUserReport Completed ==========" -Level "SUCCESS"
