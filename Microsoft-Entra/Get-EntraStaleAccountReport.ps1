<#
.SYNOPSIS
    Get-EntraStaleAccountReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraStaleAccountReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraStaleAccountReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraStaleAccountReport"
...
Write-Log "========== Get-EntraStaleAccountReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraStaleAccountReport Completed ==========" -Level "SUCCESS"
