<#
.SYNOPSIS
    Get-EntraEntitlementManagementReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraEntitlementManagementReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraEntitlementManagementReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraEntitlementManagementReport"
...
Write-Log "========== Get-EntraEntitlementManagementReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraEntitlementManagementReport Completed ==========" -Level "SUCCESS"
