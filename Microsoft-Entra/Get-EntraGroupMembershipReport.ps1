<#
.SYNOPSIS
    Get-EntraGroupMembershipReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraGroupMembershipReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraGroupMembershipReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraGroupMembershipReport"
...
Write-Log "========== Get-EntraGroupMembershipReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraGroupMembershipReport Completed ==========" -Level "SUCCESS"
