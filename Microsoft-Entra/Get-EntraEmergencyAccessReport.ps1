<#
.SYNOPSIS
    Get-EntraEmergencyAccessReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraEmergencyAccessReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraEmergencyAccessReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraEmergencyAccessReport"
...
Write-Log "========== Get-EntraEmergencyAccessReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraEmergencyAccessReport Completed ==========" -Level "SUCCESS"
