<#
.SYNOPSIS
    Enable-EntraMFA.ps1 - Microsoft Entra ID Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Enable-EntraMFA_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Enable-EntraMFA"
...
Write-Log "========== Enable-EntraMFA Started ==========" -Level "INFO"
...
Write-Log "========== Enable-EntraMFA Completed ==========" -Level "SUCCESS"
