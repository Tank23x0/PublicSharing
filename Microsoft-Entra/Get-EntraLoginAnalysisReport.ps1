<#
.SYNOPSIS
    Get-EntraLoginAnalysisReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraLoginAnalysisReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraLoginAnalysisReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraLoginAnalysisReport"
...
Write-Log "========== Get-EntraLoginAnalysisReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraLoginAnalysisReport Completed ==========" -Level "SUCCESS"
