<#
.SYNOPSIS
    Get-EntraAuditLogReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraAuditLogReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraAuditLogReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraAuditLogReport"
...
Write-Log "========== Get-EntraAuditLogReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraAuditLogReport Completed ==========" -Level "SUCCESS"
