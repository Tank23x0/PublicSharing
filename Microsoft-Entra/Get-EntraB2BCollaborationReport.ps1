<#
.SYNOPSIS
    Get-EntraB2BCollaborationReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraB2BCollaborationReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraB2BCollaborationReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraB2BCollaborationReport"
...
Write-Log "========== Get-EntraB2BCollaborationReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraB2BCollaborationReport Completed ==========" -Level "SUCCESS"
