<#
.SYNOPSIS
    Get-EntraDynamicGroupReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraDynamicGroupReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraDynamicGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraDynamicGroupReport"
...
Write-Log "========== Get-EntraDynamicGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraDynamicGroupReport Completed ==========" -Level "SUCCESS"
