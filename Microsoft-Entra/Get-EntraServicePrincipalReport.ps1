<#
.SYNOPSIS
    Get-EntraServicePrincipalReport.ps1 - Microsoft Entra ID Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraServicePrincipalReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraServicePrincipalReport"
...
Write-Log "========== Get-EntraServicePrincipalReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraServicePrincipalReport Completed ==========" -Level "SUCCESS"
