<#
.SYNOPSIS
    Export-EntraUsers.ps1 - Microsoft Entra ID Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Export-EntraUsers_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Export-EntraUsers"
...
Write-Log "========== Export-EntraUsers Started ==========" -Level "INFO"
...
Write-Log "========== Export-EntraUsers Completed ==========" -Level "SUCCESS"
