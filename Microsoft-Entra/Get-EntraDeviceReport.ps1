<#
.SYNOPSIS
    Get-EntraDeviceReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraDeviceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraDeviceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraDeviceReport"
...
Write-Log "========== Get-EntraDeviceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraDeviceReport Completed ==========" -Level "SUCCESS"
