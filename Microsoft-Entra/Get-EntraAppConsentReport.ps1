<#
.SYNOPSIS
    Get-EntraAppConsentReport.ps1 - Microsoft Entra ID Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraAppConsentReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraAppConsentReport"
...
Write-Log "========== Get-EntraAppConsentReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraAppConsentReport Completed ==========" -Level "SUCCESS"
