<#
.SYNOPSIS
    Get-EntraInactiveUserReport.ps1 - Microsoft Entra ID Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraInactiveUserReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraInactiveUserReport"
...
Write-Log "========== Get-EntraInactiveUserReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraInactiveUserReport Completed ==========" -Level "SUCCESS"
