<#
.SYNOPSIS
    Get-EntraApplicationPermissionReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraApplicationPermissionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraApplicationPermissionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraApplicationPermissionReport"
...
Write-Log "========== Get-EntraApplicationPermissionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraApplicationPermissionReport Completed ==========" -Level "SUCCESS"
