<#
.SYNOPSIS
    Get-EntraGroupReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraGroupReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraGroupReport"
...
Write-Log "========== Get-EntraGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraGroupReport Completed ==========" -Level "SUCCESS"
