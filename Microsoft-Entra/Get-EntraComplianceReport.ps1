<#
.SYNOPSIS
    Get-EntraComplianceReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraComplianceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraComplianceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)

$ScriptName = "Get-EntraComplianceReport"
...
Write-Log "========== Get-EntraComplianceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraComplianceReport Completed ==========" -Level "SUCCESS"
