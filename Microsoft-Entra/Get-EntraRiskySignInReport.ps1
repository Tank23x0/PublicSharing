<#
.SYNOPSIS
    Get-EntraRiskySignInReport.ps1 - Microsoft Entra ID Management Tool
...
.EXAMPLE
    .\Get-EntraRiskySignInReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-EntraRiskySignInReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)
...
Write-Log "========== Get-EntraRiskySignInReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-EntraRiskySignInReport Completed ==========" -Level "SUCCESS"
