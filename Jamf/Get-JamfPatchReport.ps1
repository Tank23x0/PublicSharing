<#
.SYNOPSIS
    Get-JamfPatchReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfPatchReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfPatchReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfPatchReport"
...
Write-Log "========== Get-JamfPatchReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfPatchReport Completed ==========" -Level "SUCCESS"
