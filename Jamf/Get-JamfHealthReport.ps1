<#
.SYNOPSIS
    Get-JamfHealthReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfHealthReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfHealthReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfHealthReport"
...
Write-Log "========== Get-JamfHealthReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfHealthReport Completed ==========" -Level "SUCCESS"
