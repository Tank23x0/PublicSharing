<#
.SYNOPSIS
    Get-JamfDEPReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfDEPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfDEPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfDEPReport"
...
Write-Log "========== Get-JamfDEPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfDEPReport Completed ==========" -Level "SUCCESS"
