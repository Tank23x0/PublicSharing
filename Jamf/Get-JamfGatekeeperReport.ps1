<#
.SYNOPSIS
    Get-JamfGatekeeperReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfGatekeeperReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfGatekeeperReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfGatekeeperReport"
...
Write-Log "========== Get-JamfGatekeeperReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfGatekeeperReport Completed ==========" -Level "SUCCESS"
