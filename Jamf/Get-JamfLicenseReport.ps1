<#
.SYNOPSIS
    Get-JamfLicenseReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfLicenseReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfLicenseReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfLicenseReport"
...
Write-Log "========== Get-JamfLicenseReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfLicenseReport Completed ==========" -Level "SUCCESS"
