<#
.SYNOPSIS
    Get-JamfPackageReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfPackageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfPackageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfPackageReport"
...
Write-Log "========== Get-JamfPackageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfPackageReport Completed ==========" -Level "SUCCESS"
