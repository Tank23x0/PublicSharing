<#
.SYNOPSIS
    Add-JamfDeviceToGroup.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Add-JamfDeviceToGroup.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Add-JamfDeviceToGroup_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Add-JamfDeviceToGroup"
...
Write-Log "========== Add-JamfDeviceToGroup Started ==========" -Level "INFO"
...
Write-Log "========== Add-JamfDeviceToGroup Completed ==========" -Level "SUCCESS"
