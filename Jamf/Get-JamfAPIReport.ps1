<#
.SYNOPSIS
    Get-JamfAPIReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfAPIReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfAPIReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfAPIReport"
...
Write-Log "========== Get-JamfAPIReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfAPIReport Completed ==========" -Level "SUCCESS"
