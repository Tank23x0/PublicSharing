<#
.SYNOPSIS
    Get-JamfABMReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfABMReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfABMReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfABMReport"
...
Write-Log "========== Get-JamfABMReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfABMReport Completed ==========" -Level "SUCCESS"
