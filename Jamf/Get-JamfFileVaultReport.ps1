<#
.SYNOPSIS
    Get-JamfFileVaultReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfFileVaultReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfFileVaultReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfFileVaultReport"
...
Write-Log "========== Get-JamfFileVaultReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfFileVaultReport Completed ==========" -Level "SUCCESS"
