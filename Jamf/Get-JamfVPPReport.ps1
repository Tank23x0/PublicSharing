<#
.SYNOPSIS
    Get-JamfVPPReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfVPPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfVPPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfVPPReport"
...
Write-Log "========== Get-JamfVPPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfVPPReport Completed ==========" -Level "SUCCESS"
