<#
.SYNOPSIS
    Get-JamfDepartmentReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfDepartmentReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfDepartmentReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfDepartmentReport"
...
Write-Log "========== Get-JamfDepartmentReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfDepartmentReport Completed ==========" -Level "SUCCESS"
