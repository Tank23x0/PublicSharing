<#
.SYNOPSIS
    Get-JamfGroupReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfGroupReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfGroupReport"
...
Write-Log "========== Get-JamfGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfGroupReport Completed ==========" -Level "SUCCESS"
