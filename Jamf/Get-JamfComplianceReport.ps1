<#
.SYNOPSIS
    Get-JamfComplianceReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfComplianceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfComplianceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfComplianceReport"
...
Write-Log "========== Get-JamfComplianceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfComplianceReport Completed ==========" -Level "SUCCESS"
