<#
.SYNOPSIS
    Get-JamfSoftwareUpdateReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfSoftwareUpdateReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfSoftwareUpdateReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfSoftwareUpdateReport"
...
Write-Log "========== Get-JamfSoftwareUpdateReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfSoftwareUpdateReport Completed ==========" -Level "SUCCESS"
