<#
.SYNOPSIS
    Remove-JamfDeviceFromGroup.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Remove-JamfDeviceFromGroup.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Remove-JamfDeviceFromGroup_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Remove-JamfDeviceFromGroup"
...
Write-Log "========== Remove-JamfDeviceFromGroup Started ==========" -Level "INFO"
...
Write-Log "========== Remove-JamfDeviceFromGroup Completed ==========" -Level "SUCCESS"
