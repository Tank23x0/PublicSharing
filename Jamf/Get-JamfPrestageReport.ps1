<#
.SYNOPSIS
    Get-JamfPrestageReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfPrestageReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfPrestageReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfPrestageReport"
...
Write-Log "========== Get-JamfPrestageReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfPrestageReport Completed ==========" -Level "SUCCESS"
