<#
.SYNOPSIS
    Get-JamfLostModeReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfLostModeReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfLostModeReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfLostModeReport"
...
Write-Log "========== Get-JamfLostModeReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfLostModeReport Completed ==========" -Level "SUCCESS"
