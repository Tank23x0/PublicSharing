<#
.SYNOPSIS
    Get-JamfScriptReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfScriptReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfScriptReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfScriptReport"
...
Write-Log "========== Get-JamfScriptReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfScriptReport Completed ==========" -Level "SUCCESS"
