<#
.SYNOPSIS
    Get-JamfFirewallReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfFirewallReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfFirewallReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfFirewallReport"
...
Write-Log "========== Get-JamfFirewallReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfFirewallReport Completed ==========" -Level "SUCCESS"
