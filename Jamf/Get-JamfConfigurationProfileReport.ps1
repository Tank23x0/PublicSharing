<#
.SYNOPSIS
    Get-JamfConfigurationProfileReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfConfigurationProfileReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfConfigurationProfileReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfConfigurationProfileReport"
...
Write-Log "========== Get-JamfConfigurationProfileReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfConfigurationProfileReport Completed ==========" -Level "SUCCESS"
