<#
.SYNOPSIS
    Send-JamfCommand.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Send-JamfCommand.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Send-JamfCommand_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Send-JamfCommand"
...
Write-Log "========== Send-JamfCommand Started ==========" -Level "INFO"
...
Write-Log "========== Send-JamfCommand Completed ==========" -Level "SUCCESS"
