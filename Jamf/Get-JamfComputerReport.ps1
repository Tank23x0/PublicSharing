<#
.SYNOPSIS
    Get-JamfComputerReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfComputerReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfComputerReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfComputerReport"
...
Write-Log "========== Get-JamfComputerReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfComputerReport Completed ==========" -Level "SUCCESS"
