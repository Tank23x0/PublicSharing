<#
.SYNOPSIS
    Get-JamfActivationLockReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfActivationLockReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfActivationLockReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfActivationLockReport"
...
Write-Log "========== Get-JamfActivationLockReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfActivationLockReport Completed ==========" -Level "SUCCESS"
