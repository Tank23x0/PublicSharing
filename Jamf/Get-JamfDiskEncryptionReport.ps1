<#
.SYNOPSIS
    Get-JamfDiskEncryptionReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfDiskEncryptionReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfDiskEncryptionReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfDiskEncryptionReport"
...
Write-Log "========== Get-JamfDiskEncryptionReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfDiskEncryptionReport Completed ==========" -Level "SUCCESS"
