<#
.SYNOPSIS
    Get-JamfAppReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfAppReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfAppReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfAppReport"
...
Write-Log "========== Get-JamfAppReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfAppReport Completed ==========" -Level "SUCCESS"
