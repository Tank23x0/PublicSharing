<#
.SYNOPSIS
    Get-JamfUserReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfUserReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfUserReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfUserReport"
...
Write-Log "========== Get-JamfUserReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfUserReport Completed ==========" -Level "SUCCESS"
