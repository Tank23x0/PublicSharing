<#
.SYNOPSIS
    Get-JamfPatchPolicyReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfPatchPolicyReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfPatchPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfPatchPolicyReport"
...
Write-Log "========== Get-JamfPatchPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfPatchPolicyReport Completed ==========" -Level "SUCCESS"
