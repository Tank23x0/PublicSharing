<#
.SYNOPSIS
    Get-JamfRestrictedSoftwareReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfRestrictedSoftwareReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfRestrictedSoftwareReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfRestrictedSoftwareReport"
...
Write-Log "========== Get-JamfRestrictedSoftwareReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfRestrictedSoftwareReport Completed ==========" -Level "SUCCESS"
