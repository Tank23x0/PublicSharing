<#
.SYNOPSIS
    Get-JamfDeviceReport.ps1 - Jamf Pro Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfDeviceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfDeviceReport"
...
Write-Log "========== Get-JamfDeviceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfDeviceReport Completed ==========" -Level "SUCCESS"
