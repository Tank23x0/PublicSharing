<#
.SYNOPSIS
    Get-JamfHardwareReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfHardwareReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfHardwareReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfHardwareReport"
...
Write-Log "========== Get-JamfHardwareReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfHardwareReport Completed ==========" -Level "SUCCESS"
