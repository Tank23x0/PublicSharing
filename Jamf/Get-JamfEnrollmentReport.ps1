<#
.SYNOPSIS
    Get-JamfEnrollmentReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfEnrollmentReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfEnrollmentReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfEnrollmentReport"
...
Write-Log "========== Get-JamfEnrollmentReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfEnrollmentReport Completed ==========" -Level "SUCCESS"
