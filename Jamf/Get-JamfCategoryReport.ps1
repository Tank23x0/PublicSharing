<#
.SYNOPSIS
    Get-JamfCategoryReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfCategoryReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfCategoryReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfCategoryReport"
...
Write-Log "========== Get-JamfCategoryReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfCategoryReport Completed ==========" -Level "SUCCESS"
