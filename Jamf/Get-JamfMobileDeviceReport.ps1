<#
.SYNOPSIS
    Get-JamfMobileDeviceReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfMobileDeviceReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfMobileDeviceReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfMobileDeviceReport"
...
Write-Log "========== Get-JamfMobileDeviceReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfMobileDeviceReport Completed ==========" -Level "SUCCESS"
