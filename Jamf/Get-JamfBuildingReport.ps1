<#
.SYNOPSIS
    Get-JamfBuildingReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfBuildingReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfBuildingReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfBuildingReport"
...
Write-Log "========== Get-JamfBuildingReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfBuildingReport Completed ==========" -Level "SUCCESS"
