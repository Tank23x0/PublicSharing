<#
.SYNOPSIS
    Get-JamfExtensionAttributeReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfExtensionAttributeReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfExtensionAttributeReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfExtensionAttributeReport"
...
Write-Log "========== Get-JamfExtensionAttributeReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfExtensionAttributeReport Completed ==========" -Level "SUCCESS"
