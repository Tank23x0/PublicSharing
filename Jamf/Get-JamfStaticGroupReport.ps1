<#
.SYNOPSIS
    Get-JamfStaticGroupReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfStaticGroupReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfStaticGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfStaticGroupReport"
...
Write-Log "========== Get-JamfStaticGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfStaticGroupReport Completed ==========" -Level "SUCCESS"
