<#
.SYNOPSIS
    Get-JamfSecurityReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfSecurityReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfSecurityReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfSecurityReport"
...
Write-Log "========== Get-JamfSecurityReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfSecurityReport Completed ==========" -Level "SUCCESS"
