<#
.SYNOPSIS
    Get-JamfSmartGroupReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfSmartGroupReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfSmartGroupReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfSmartGroupReport"
...
Write-Log "========== Get-JamfSmartGroupReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfSmartGroupReport Completed ==========" -Level "SUCCESS"
