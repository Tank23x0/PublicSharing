<#
.SYNOPSIS
    Get-JamfSSOReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfSSOReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfSSOReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfSSOReport"
...
Write-Log "========== Get-JamfSSOReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfSSOReport Completed ==========" -Level "SUCCESS"
