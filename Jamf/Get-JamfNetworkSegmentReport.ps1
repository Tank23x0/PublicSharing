<#
.SYNOPSIS
    Get-JamfNetworkSegmentReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfNetworkSegmentReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfNetworkSegmentReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfNetworkSegmentReport"
...
Write-Log "========== Get-JamfNetworkSegmentReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfNetworkSegmentReport Completed ==========" -Level "SUCCESS"
