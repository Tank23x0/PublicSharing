<#
.SYNOPSIS
    Get-JamfPolicyReport.ps1 - Jamf Pro Management Tool
...
[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfPolicyReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfPolicyReport"
...
Write-Log "========== Get-JamfPolicyReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfPolicyReport Completed ==========" -Level "SUCCESS"
