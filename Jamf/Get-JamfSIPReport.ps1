<#
.SYNOPSIS
    Get-JamfSIPReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfSIPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfSIPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfSIPReport"
...
Write-Log "========== Get-JamfSIPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfSIPReport Completed ==========" -Level "SUCCESS"
