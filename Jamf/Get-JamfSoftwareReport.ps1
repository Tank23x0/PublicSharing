<#
.SYNOPSIS
    Get-JamfSoftwareReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfSoftwareReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfSoftwareReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfSoftwareReport"
...
Write-Log "========== Get-JamfSoftwareReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfSoftwareReport Completed ==========" -Level "SUCCESS"
