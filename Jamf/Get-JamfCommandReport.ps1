<#
.SYNOPSIS
    Get-JamfCommandReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfCommandReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfCommandReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfCommandReport"
...
Write-Log "========== Get-JamfCommandReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfCommandReport Completed ==========" -Level "SUCCESS"
