<#
.SYNOPSIS
    Get-JamfInventoryReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfInventoryReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfInventoryReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfInventoryReport"
...
Write-Log "========== Get-JamfInventoryReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfInventoryReport Completed ==========" -Level "SUCCESS"
