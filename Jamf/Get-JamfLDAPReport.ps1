<#
.SYNOPSIS
    Get-JamfLDAPReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfLDAPReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfLDAPReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfLDAPReport"
...
Write-Log "========== Get-JamfLDAPReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfLDAPReport Completed ==========" -Level "SUCCESS"
