<#
.SYNOPSIS
    Get-JamfWebhookReport.ps1 - Jamf Pro Management Tool
...
.EXAMPLE
    .\Get-JamfWebhookReport.ps1
#>

[CmdletBinding()]
param(
    [string]$OutputPath = "$env:USERPROFILE\Documents\Get-JamfWebhookReport_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv",
    [string]$JamfURL,
    [string]$Username
)

$ScriptName = "Get-JamfWebhookReport"
...
Write-Log "========== Get-JamfWebhookReport Started ==========" -Level "INFO"
...
Write-Log "========== Get-JamfWebhookReport Completed ==========" -Level "SUCCESS"
